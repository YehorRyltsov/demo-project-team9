 ...
 * limitations under the License.
 */
function(e=ze()){const t=Me(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Me(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(q(n.getOptions(),null!=t?t:{}))return e;tt(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Si,persistence:[Vn,Ln,An]})}(Fe(Pi));function su(e,n){Tn(ru,e,n).then((n=>{t(l).Notify.success(`Yahoooo!!!! Welcome ${e}`);n.user})).catch((e=>{e.code,e.message;console.error(e.message),t(l).Notify.failure("We cant create user likes this")}))}function ou(e,n){En(ru,e,n).then((e=>{t(l).Notify.success("Login success");e.user})).catch((e=>{t(l).Notify.failure("Login failure")}))}function au(){J(ru).signOut(),t(l).Notify.info("You just logOut"),nu(1)}const lu=document.querySelector(".header"),cu=document.querySelector(".search-form"),uu=document.querySelector(".home-link"),hu=document.querySelector(".library-link"),du=document.querySelector(".library-btn__wrap"),pu=document.querySelector(".gallery-films");const fu=document.querySelector("#email-input"),mu=document.querySelector("#pwd-input"),gu=document.querySelector("#second-pwd-input"),yu=document.querySelector("#register-form"),vu=document.querySelector('button[data-id="log-out"]'),_u=document.querySelector("#login-email-input"),bu=document.querySelector("#login-pwd-input"),wu=document.querySelector("#login-form"),xu=(document.querySelector("#form-login-btn"),document.querySelector("#form-signup-btn")),ku=document.querySelector(".form-register-svg.pwdInput"),Cu=document.querySelector(".form-register-svg.pwdRepeatInput"),Iu=document.querySelector('button[data-id="log-in"]'),Nu=document.querySelector("[data-log-modal]"),Tu=document.querySelector("body");let Eu=null;var Su,Ru,Lu;function Pu(e){const t=e.currentTarget,n=mu.value;t.value===n?(mu.classList.add("checked"),gu.classList.add("checked"),ku.classList.add("checked"),Cu.classList.add("checked"),xu.disabled=!1):(Au(),xu.disabled=!0)}function Au(){mu.classList.remove("checked"),gu.classList.remove("checked"),ku.classList.remove("checked"),Cu.classList.remove("checked")}vu.addEventListener("click",(function(){au(),du.classList.add("visually-hidden"),cu.classList.remove("visually-hidden"),uu.classList.add("current"),hu.classList.remove("current"),lu.classList.remove("header__my-library-bg"),lu.classList.add("home-header-bg"),pu.classList.add("gallery-films"),nu(1)})),yu.addEventListener("submit",(function(e){e.preventDefault(),Au();try{su(fu.value,mu.value),e.currentTarget.reset()}catch(t){e.currentTarget.reset()}})),wu.addEventListener("submit",(function(e){e.preventDefault();try{ou(_u.value,bu.value),e.currentTarget.reset()}catch(e){}})),Su=e=>{e?(Iu.classList.add("visually-hidden"),vu.classList.remove("visually-hidden"),Nu.classList.add("is-hidden"),Tu.classList.remove("no-scroll"),Eu=e.uid,console.log(`юзер залогинен, ID = ${e.uid}`)):(Eu=null,Iu.classList.remove("visually-hidden"),vu.classList.add("visually-hidden"))},J(ru).onAuthStateChanged(Su,Ru,Lu);var Mu;Mu=new URL(s("kyEFX").resolve("q2LMx"),import.meta.url).toString();let Ou=[],Du=[];const Fu=document.querySelector(".header"),zu=document.querySelector(".search-form"),Wu=document.querySelector(".home-link"),qu=document.querySelector(".library-link"),Uu=document.querySelector(".library-btn__wrap"),Bu=document.querySelector(".watched-btn"),ju=document.querySelector(".queue-btn"),Hu=document.querySelector(".logo-link"),Vu=document.querySelector(".section-pagination"),$u=document.querySelector("#pagination"),Xu=document.querySelector(".gallery-films");function Ku(e){Uu.classList.add("visually-hidden"),zu.classList.remove("visually-hidden"),Wu.classList.add("current"),qu.classList.remove("current"),Fu.classList.remove("header__my-library-bg"),Fu.classList.add("home-header-bg"),$u.style.display="flex",Xu.classList.add("gallery-films")}function Yu(){Du=vc(Eu),Ou=yc(Eu)}function Gu(e){e.currentTarget.classList.contains("watched-btn")?(ju.classList.remove("active"),Bu.classList.add("active"),Bu.disabled=!0,ju.disabled=!1):e.currentTarget.classList.contains("queue-btn")?(Bu.classList.remove("active"),ju.classList.add("active"),Bu.disabled=!1,ju.disabled=!0):(Bu.classList.remove("active"),ju.classList.add("active"))}function Qu(e){Yu(),Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600),setTimeout((function(){if(e.length>=1)return function(e){const t=e.map((e=>{let{poster_path:t,original_title:n,genres:i,release_date:r,vote_average:s,id:o}=e;return function(e,t,n,i,r,s){const o=new Date(`${i}`).getFullYear(),a=n.map((e=>e.name));return`\n                <li class="photo-card" data-idcard="${s}">\n                <a class="link" href="#">\n                  <img src= "https://image.tmdb.org/t/p/w500${e}" alt="${t} loading="lazy" width: 0px class="card-image">\n                  <div class="info">\n                    <p class="info-item">\n                      <b>${t.toUpperCase()}</b>\n                    </p>\n                    <p class="info-item">\n                    <b class="info-genres">${a.join(", ")} | ${o} <span class="info-genres vote-average">${r.toFixed(1)}</span></b>                      \n                                          </p>                   \n                  </div>\n                  </a>\n                </li>`}(t,n,i,r,s,o)}));Xu.innerHTML="",Xu.insertAdjacentHTML("afterbegin",t.join(""))}(e);Xu.style.justifyContent="center",Xu.innerHTML=`<li>\n  <p class="empty-library__text"> There is nothing here yet! </p>\n  <img class="empty-library__image" src="${t(Mu)}" alt="empty cinema hall">\n  </li>`,document.querySelector(".empty-library__text").style.margin="0",Vu.style.display="none"}),300)}Wu.addEventListener("click",Ku),qu.addEventListener("click",(function(e){e.preventDefault(),Yu(),Gu(e),Eu?(zu.classList.add("visually-hidden"),Uu.classList.remove("visually-hidden"),qu.classList.add("current"),Wu.classList.remove("current"),Fu.classList.remove("home-header-bg"),Fu.classList.add("header__my-library-bg"),Qu(Du)):Ic()})),Bu.addEventListener("click",(function(e){Gu(e),Qu(Ou)})),ju.addEventListener("click",(function(e){Gu(e),Qu(Du)})),Hu.addEventListener("click",Ku);var Ju={};Ju=function e(t,n,i){function r(o,a){if(!n[o]){if(!t[o]){var l=void 0;if(!a&&l)return l(o,!0);if(s)return s(o,!0);var c=new Error("Cannot find module '"+o+"'");throw c.code="MODULE_NOT_FOUND",c}var u=n[o]={exports:{}};t[o][0].call(u.exports,(function(e){return r(t[o][1][e]||e)}),u,u.exports,e,t,n,i)}return n[o].exports}for(var s=void 0,o=0;o<i.length;o++)r(i[o]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var i=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},s=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=s,n.create=function(e,t){var n=function(e,t){var n=i('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),s=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return s.appendChild(e)}));var o=r(s,"IMG"),a=r(s,"VIDEO"),l=r(s,"IFRAME");return!0===o&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===l&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(i(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),o=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===s(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&o()}));var a={element:function(){return n},visible:function(){return s(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:o};return a}},{}]},{},[1])(1);var Zu;Zu=new URL(s("kyEFX").resolve("gOLlt"),import.meta.url).toString();var eh;eh=new URL(s("kyEFX").resolve("iTfR5"),import.meta.url).toString();var th;th=new URL(s("kyEFX").resolve("7nYPu"),import.meta.url).toString();var nh;nh=new URL(s("kyEFX").resolve("fkcxk"),import.meta.url).toString();var ih;ih=new URL(s("kyEFX").resolve("acMhR"),import.meta.url).toString();var rh;rh=new URL(s("kyEFX").resolve("cshoN"),import.meta.url).toString();var sh;sh=new URL(s("kyEFX").resolve("jOnoa"),import.meta.url).toString();var oh;oh=new URL(s("kyEFX").resolve("eQ6pA"),import.meta.url).toString();var ah;ah=new URL(s("kyEFX").resolve("em9Db"),import.meta.url).toString();var lh;lh=new URL(s("kyEFX").resolve("6n6Lh"),import.meta.url).toString();var ch;ch=new URL(s("kyEFX").resolve("eqJcO"),import.meta.url).toString();var uh;uh=new URL(s("kyEFX").resolve("56Ciu"),import.meta.url).toString();const hh=`<div class="modal-team" id="modalTeam"><div class="team-card">\n    <img src="${t(Zu)}" alt="Yegor" class="team-image">\n    <p class="team-name">Yegor</p>\n    <p class="team-role">'Developer, TeamLead'</p>\n    <a href="https://github.com/YehorRyltsov" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#github"></use>\n    </svg></a>\n    <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(eh)}" alt="Valerii" class="team-image">\n    <p class="team-name">Valerii</p>\n    <p class="team-role">'Developer, Scram master'</p>\n    <a href="https://github.com/Valerii-Postrybailo" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(th)}" alt="Khrystyna" class="team-image">\n    <p class="team-name">Khrystyna</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/kmykolaichuk" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/khrystyna-mykolaichuk-29275b163" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(nh)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/NataliiaKulchytska" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ih)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Nataliphoenix" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(rh)}" alt="Sergei" class="team-image">\n    <p class="team-name">Sergei</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/seroga213" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(sh)}" alt="Vitalii" class="team-image">\n    <p class="team-name">Vitaliy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/VitaliiMazur" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/vitalii-mazur-5612b9237" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(oh)}" alt=">Yuriy" class="team-image">\n    <p class="team-name">Yura</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Shavursky" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(lh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Scumsy" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ah)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/bigmandarine" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ch)}" alt="Arseniy" class="team-image">\n    <p class="team-name">Arseniy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/arseniy-grinev" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(uh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(uh)}#in"></use>\n    </svg></a>\n</div>\n</div>\n`,dh=document.querySelector("[data-modal-open-team]"),ph=document.querySelector("body");document.querySelector("#modalTeam");dh.addEventListener("click",(function(e){e.preventDefault(),fh.show(),window.addEventListener("keydown",mh),ph.classList.add("noScroll"),mh(e)}));const fh=Ju.create(hh,{onClose:e=>{ph.classList.remove("noScroll")}});function mh(e){"Escape"===e.code&&(fh.close(),window.removeEventListener("keydown",mh))}const gh=document.querySelector(".scroll-top");gh.addEventListener("click",(function(e){window.scrollTo({top:0,behavior:"smooth"}),Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600)})),window.addEventListener("scroll",(function(e){window.pageYOffset<100?gh.classList.add("is-hidden"):gh.classList.remove("is-hidden")}));Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(400),t(l).Notify.init({position:"center-top"});
//# sourceMappingURL=index.b3792f5a.js.map
