 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();var ad=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:wt(),t=arguments.length>1?arguments[1]:void 0;return yt(e,"database").getImmediate({identifier:t})}(bt(Va)),od="";var sd={addWatched:document.querySelector("#add-watched"),addQueue:document.querySelector("#add-queue"),removeWatched:document.querySelector("#remove-watched"),removeQueue:document.querySelector("#remove-queue"),getWatched:document.querySelector("#get-watched"),getQueue:document.querySelector("#get-queue")};sd.addWatched.addEventListener("click",(function(){console.log(no),no||console.log("добавить всплывашку залогинься");e=no,t=ud,Qh(Jh(Gh(ad,"user/".concat(e,"/watched/"))),t);var e,t})),sd.removeWatched.addEventListener("click",(function(){e=no,t=cd,ed(Gh(ad,"user/".concat(e,"/watched/")),(function(e){e.forEach((function(e){e.val().id===t&&(od=e.key)}))}),{onlyOnce:!0}),Qh(Gh(ad,"user/".concat(e,"/watched/").concat(od)),null);var e,t})),sd.addQueue.addEventListener("click",(function(){console.log(no),no||console.log("добавить всплывашку залогинься");e=no,t=ud,cd=void Qh(Jh(Gh(ad,"user/".concat(e,"/queue/"))),t),console.log(cd);var e,t})),sd.removeQueue.addEventListener("click",(function(){e=no,t=cd,ed(Gh(ad,"user/".concat(e,"/queue/")),(function(e){e.forEach((function(e){e.val().id===t&&(od=e.key)}))}),{onlyOnce:!0}),Qh(Gh(ad,"user/".concat(e,"/queue/").concat(od)),null);var e,t})),sd.getWatched.addEventListener("click",(function(){e=no,t=[],ed(Gh(ad,"user/".concat(e,"/watched/")),(function(e){e.forEach((function(e){t.push(e.val())}))}),{onlyOnce:!0}),console.log(t);var e,t})),sd.getQueue.addEventListener("click",(function(){e=no,t=[],ed(Gh(ad,"user/".concat(e,"/queue/")),(function(e){e.forEach((function(e){t.push(e.val())}))}),{onlyOnce:!0}),console.dir(t);var e,t}));var ud={adult:!1,backdrop_path:"/jsoz1HlxczSuTx0mDl2h0lxy36l.jpg",belongs_to_collection:{id:131296,name:"Thor Collection",poster_path:"/yw7gr7DhHHVTLlO8Se8uH17TDMA.jpg",backdrop_path:"/3KL8UNKFWgIKXzLHjwY0uwgjzYl.jpg"},budget:25e7,genres:[{id:14,name:"Fantasy"},{id:28,name:"Action"},{id:35,name:"Comedy"}],homepage:"https://www.marvel.com/movies/thor-love-and-thunder",id:616037,imdb_id:"tt10648342",original_language:"en",original_title:"Thor: Love and Thunder",overview:"After his retirement is interrupted by Gorr the God Butcher, a galactic killer who seeks the extinction of the gods, Thor Odinson enlists the help of King Valkyrie, Korg, and ex-girlfriend Jane Foster, who now wields Mjolnir as the Mighty Thor. Together they embark upon a harrowing cosmic adventure to uncover the mystery of the God Butcher’s vengeance and stop him before it’s too late.",popularity:1869.63,poster_path:"/pIkRyD18kl4FhoCNQuWxWu5cBLM.jpg",production_companies:[{id:420,logo_path:"/hUzeosd33nzE5MCNsZxCGEKTXaQ.png",name:"Marvel Studios",origin_country:"US"},{id:176762,logo_path:null,name:"Kevin Feige Productions",origin_country:"US"}],production_countries:[{iso_3166_1:"US",name:"United States of America"}],release_date:"2022-07-06",revenue:758004063,runtime:119,spoken_languages:[{english_name:"English",iso_639_1:"en",name:"English"}],status:"Released",tagline:"The one is not the only.",title:"Thor: Love and Thunder",video:!1,vote_average:6.772,vote_count:3840},cd=ud.id;var ld=document.querySelector(".header"),hd=document.querySelector(".search-form"),dd=document.querySelector(".home-link"),fd=document.querySelector(".library-link"),vd=document.querySelector(".library-btn__wrap"),pd=document.querySelector(".watched-btn"),yd=document.querySelector(".queue-btn"),_d=document.querySelector(".logo-link");function md(e){e.preventDefault(),vd.classList.add("visually-hidden"),hd.classList.remove("visually-hidden"),dd.classList.add("current"),fd.classList.remove("current"),ld.classList.remove("header__my-library-bg"),ld.classList.add("home-header-bg")}dd.addEventListener("click",md),fd.addEventListener("click",(function(e){e.preventDefault(),hd.classList.add("visually-hidden"),vd.classList.remove("visually-hidden"),fd.classList.add("current"),dd.classList.remove("current"),ld.classList.remove("home-header-bg"),ld.classList.add("header__my-library-bg")})),pd.addEventListener("click",(function(){yd.classList.remove("active"),pd.classList.add("active")})),yd.addEventListener("click",(function(){pd.classList.remove("active"),yd.classList.add("active")})),_d.addEventListener("click",md)}();
//# sourceMappingURL=index.4569e08a.js.map
