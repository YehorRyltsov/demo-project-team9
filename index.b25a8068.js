 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T=function(e){let t={},n={},i={},r="";try{const s=e.split(".");t=C(l(s[0])||""),n=C(l(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},E=function(e){const t=T(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},k=function(e){const t=T(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function B(e){return e&&e._delegate?e._delegate:e}class V{setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}}
/**
 * @license
 ...
 * limitations under the License.
 */
const ke=new w("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw ke.create("bad-app-name",{appName:String(i)});const r=be.get(i);if(r){if(x(e,r.options)&&x(n,r.config))return r;throw ke.create("duplicate-app",{appName:i})}const s=new $(i);for(const e of Ce.values())s.addComponent(e);const o=new Se(e,n,s);return be.set(i,o),o}function Ne(e="[DEFAULT]"){const t=be.get(e);if(!t)throw ke.create("no-app",{appName:e});return t}function Re(e,t,n){var i;let r=null!==(i=we[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${r}" with version "${t}":`];return s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void ye.warn(e.join(" "))}Te(new V(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let xe=null;function Oe(){return xe||(xe=pe("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw ke.create("idb-open",{originalErrorMessage:e.message})}))),xe}async function Ae(e,t){var n;try{const n=(await Oe()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,De(e)),n.done}catch(e){if(e instanceof y)ye.warn(e.message);else{const t=ke.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});ye.warn(t.message)}}}function De(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Me{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Le();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Le(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let i=e.slice();for(const r of e){const e=n.find((e=>e.agent===r.agent));if(e){if(e.dates.push(r.date),Ue(n)>t){e.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),Ue(n)>t){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}(this._heartbeatsCache.heartbeats),i=c(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Fe(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function Le(){return(new Date).toISOString().substring(0,10)}class Fe{async runIndexedDBEnvironmentCheck(){return"object"==typeof indexedDB&&new Promise(((e,t)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(i),e(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var e;t((null===(e=r.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){var t;try{return(await Oe()).transaction("firebase-heartbeat-store").objectStore("firebase-heartbeat-store").get(De(e))}catch(e){if(e instanceof y)ye.warn(e.message);else{const n=ke.create("idb-get",{originalErrorMessage:null===(t=e)||void 0===t?void 0:t.message});ye.warn(n.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Ae(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Ae(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function Ue(e){return c(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var qe;qe="",Te(new V("platform-logger",(e=>new ve(e)),"PRIVATE")),Te(new V("heartbeat",(e=>new Me(e)),"PRIVATE")),Re("@firebase/app","0.7.33",qe),Re("@firebase/app","0.7.33","esm2017"),Re("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
Re("firebase","9.10.0","app");function je(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(n[i[r]]=e[i[r]])}return n}Object.create;Object.create;function We(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const He=We,Be=new w("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),Ve=new ee("@firebase/auth");function ze(e,...t){Ve.logLevel<=G.ERROR&&Ve.error(`Auth (9.10.0): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(e,...t){throw Ye(e,...t)}function Ke(e,...t){return Ye(e,...t)}function Ge(e,t,n){const i=Object.assign(Object.assign({},He()),{[t]:n});return new w("auth","Firebase",i).create(t,{appName:e.name})}function Ye(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return Be.create(e,...t)}function Je(e,t,...n){if(!e)throw Ye(t,...n)}function Qe(e){const t="INTERNAL ASSERTION FAILED: "+e;throw ze(t),new Error(t)}function Xe(e,t){e||Qe(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class st{get(){return rt()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}constructor(e,t){this.shortDelay=e,this.longDelay=t,Xe(t>e,"Short delay should be less than long delay!"),this.isMobile=f()||g()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function ut(e,t,n,i,r={}){return dt(e,r,(async()=>{let r={},s={};i&&("GET"===t?s=i:r={body:JSON.stringify(i)});const o=A(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),at.fetch()(ft(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},r))}))}async function dt(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},ct),t);try{const t=new _t(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await r.json();if("needConfirmation"in s)throw gt(e,"account-exists-with-different-credential",s);if(r.ok&&!("errorMessage"in s))return s;{const t=r.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw gt(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw gt(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw gt(e,"user-disabled",s);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw Ge(e,a,o);$e(e,a)}}catch(t){if(t instanceof y)throw t;$e(e,"network-request-failed")}}async function pt(e,t,n,i,r={}){const s=await ut(e,t,n,i,r);return"mfaPendingCredential"in s&&$e(e,"multi-factor-auth-required",{_serverResponse:s}),s}function ft(e,t,n,i){const r=`${t}${n}?${i}`;return e.config.emulator?ot(e.config,r):`${e.config.apiScheme}://${r}`}class _t{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Ke(this.auth,"network-request-failed"))),lt.get())}))}}function gt(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=Ke(e,t,i);return r.customData._tokenResponse=n,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vt(e){return 1e3*Number(e)}function yt(e){var t;const[n,i,r]=e.split(".");if(void 0===n||void 0===i||void 0===r)return ze("JWT malformed, contained fewer than 3 sections"),null;try{const e=l(i);return e?JSON.parse(e):(ze("Failed to decode base64 JWT payload"),null)}catch(e){return ze("Caught error parsing JWT payload as JSON",null===(t=e)||void 0===t?void 0:t.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{_initializeTime(){this.lastSignInTime=mt(this.lastLoginAt),this.creationTime=mt(this.createdAt)}_copy(e){this.createdAt=e.createdAt,this.lastLoginAt=e.lastLoginAt,this._initializeTime()}toJSON(){return{createdAt:this.createdAt,lastLoginAt:this.lastLoginAt}}constructor(e,t){this.createdAt=e,this.lastLoginAt=t,this._initializeTime()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St{async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return void 0===t?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}constructor(){this.type="NONE",this.storage={}}}St.type="NONE";const Pt=St;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Mt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ot(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ft(t))return"Blackberry";if(Ut(t))return"Webos";if(At(t))return"Safari";if((t.includes("chrome/")||Dt(t))&&!t.includes("edge/"))return"Chrome";if(Lt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ot(e=p()){return/firefox\//i.test(e)}function At(e=p()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Dt(e=p()){return/crios\//i.test(e)}function Mt(e=p()){return/iemobile/i.test(e)}function Lt(e=p()){return/android/i.test(e)}function Ft(e=p()){return/blackberry/i.test(e)}function Ut(e=p()){return/webos/i.test(e)}function qt(e=p()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function jt(){return m()&&10===document.documentMode}function Wt(e=p()){return qt(e)||Lt(e)||Ut(e)||Ft(e)||/windows phone/i.test(e)||Mt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ht(e,t=[]){let n;switch(e){case"Browser":n=xt(p());break;case"Worker":n=`${xt(p())}-${e}`;break;default:n=e}return`${n}/JsCore/9.10.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{static parseLink(e){const t=function(e){const t=D(M(e)).link,n=t?D(M(t)).deep_link_id:null,i=D(M(e)).deep_link_id;return(i?D(M(i)).link:null)||i||n||t||e}(e);try{return new en(t)}catch(e){return null}}constructor(e){var t,n,i,r,s,o;const a=D(M(e)),c=null!==(t=a.apiKey)&&void 0!==t?t:null,l=null!==(n=a.oobCode)&&void 0!==n?n:null,h=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);Je(c&&l&&h,"argument-error"),this.apiKey=c,this.operation=h,this.code=l,this.continueUrl=null!==(r=a.continueUrl)&&void 0!==r?r:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gn(e,t,n=!1){const i="signIn",r=await pn(e,i,t),s=await hn._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function mn(e,t){return gn(zt(e),t)}async function vn(e,t,n){const i=zt(e),r=await ln(i,{returnSecureToken:!0,email:t,password:n}),s=await hn._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(s.user),s}function yn(e,t,n){return mn(B(e),tn.credential(t,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In extends wn{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}In.type="SESSION";const Tn=In;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function Nn(){return void 0!==Pn().WorkerGlobalScope&&"function"==typeof Pn().importScripts}class Rn{toPromise(){return new Promise(((e,t)=>{this.request.addEventListener("success",(()=>{e(this.request.result)})),this.request.addEventListener("error",(()=>{t(this.request.error)}))}))}constructor(e){this.request=e}}function xn(e,t){return e.transaction(["firebaseLocalStorage"],t?"readwrite":"readonly").objectStore("firebaseLocalStorage")}function On(){const e=indexedDB.open("firebaseLocalStorageDb",1);return new Promise(((t,n)=>{e.addEventListener("error",(()=>{n(e.error)})),e.addEventListener("upgradeneeded",(()=>{const t=e.result;try{t.createObjectStore("firebaseLocalStorage",{keyPath:"fbase_key"})}catch(e){n(e)}})),e.addEventListener("success",(async()=>{const n=e.result;n.objectStoreNames.contains("firebaseLocalStorage")?t(n):(n.close(),await function(){const e=indexedDB.deleteDatabase("firebaseLocalStorageDb");return new Rn(e).toPromise()}(),t(await On()))}))}))}async function An(e,t,n){const i=xn(e,!0).put({fbase_key:t,value:n});return new Rn(i).toPromise()}function Dn(e,t){const n=xn(e,!0).delete(t);return new Rn(n).toPromise()}class Mn{async _openDb(){return this.db||(this.db=await On()),this.db}async _withRetries(e){let t=0;for(;;)try{const t=await this._openDb();return await e(t)}catch(e){if(t++>3)throw e;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return Nn()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=En._getInstance(Nn()?self:null),this.receiver._subscribe("keyChanged",(async(e,t)=>({keyProcessed:(await this._poll()).includes(t.key)}))),this.receiver._subscribe("ping",(async(e,t)=>["keyChanged"]))}async initializeSender(){var e,t;if(this.activeServiceWorker=await async function(){if(!(null===navigator||void 0===navigator?void 0:navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch(e){return null}}(),!this.activeServiceWorker)return;this.sender=new Sn(this.activeServiceWorker);const n=await this.sender._send("ping",{},800);n&&(null===(e=n[0])||void 0===e?void 0:e.fulfilled)&&(null===(t=n[0])||void 0===t?void 0:t.value.includes("keyChanged"))&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){var t;if(this.sender&&this.activeServiceWorker&&((null===(t=null===navigator||void 0===navigator?void 0:navigator.serviceWorker)||void 0===t?void 0:t.controller)||null)===this.activeServiceWorker)try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch(t){}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await On();return await An(e,"__sak","1"),await Dn(e,"__sak"),!0}catch(e){}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,t){return this._withPendingWrite((async()=>(await this._withRetries((n=>An(n,e,t))),this.localCache[e]=t,this.notifyServiceWorker(e))))}async _get(e){const t=await this._withRetries((t=>async function(e,t){const n=xn(e,!1).get(t),i=await new Rn(n).toPromise();return void 0===i?null:i.value}(t,e)));return this.localCache[e]=t,t}async _remove(e){return this._withPendingWrite((async()=>(await this._withRetries((t=>Dn(t,e))),delete this.localCache[e],this.notifyServiceWorker(e))))}async _poll(){const e=await this._withRetries((e=>{const t=xn(e,!1).getAll();return new Rn(t).toPromise()}));if(!e)return[];if(0!==this.pendingWrites)return[];const t=[],n=new Set;for(const{fbase_key:i,value:r}of e)n.add(i),JSON.stringify(this.localCache[i])!==JSON.stringify(r)&&(this.notifyListeners(i,r),t.push(i));for(const e of Object.keys(this.localCache))this.localCache[e]&&!n.has(e)&&(this.notifyListeners(e,null),t.push(e));return t}notifyListeners(e,t){this.localCache[e]=t;const n=this.listeners[e];if(n)for(const e of Array.from(n))e(t)}startPolling(){this.stopPolling(),this.pollTimer=setInterval((async()=>this._poll()),800)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,t){0===Object.keys(this.listeners).length&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(t)}_removeListener(e,t){this.listeners[e]&&(this.listeners[e].delete(t),0===this.listeners[e].size&&delete this.listeners[e]),0===Object.keys(this.listeners).length&&this.stopPolling()}constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then((()=>{}),(()=>{}))}}Mn.type="LOCAL";const Ln=Mn;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class jn{verifyPhoneNumber(e,t){return qn(this.auth,e,B(t))}static credential(e,t){return Zt._fromVerification(e,t)}static credentialFromResult(e){const t=e;return jn.credentialFromTaggedObject(t)}static credentialFromError(e){return jn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:n}=e;return t&&n?Zt._fromTokenResponse(t,n):null}constructor(e){this.providerId=jn.PROVIDER_ID,this.auth=zt(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Bn;case"linkViaPopup":case"linkViaRedirect":return zn;case"reauthViaPopup":case"reauthViaRedirect":return Vn;default:$e(this.auth,"internal-error")}}resolve(e){Xe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Xe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci=new st(3e4,6e4);function li(){const e=Pn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let hi=null;function ui(e){return hi=hi||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){li(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{li(),n(Ke(e,"network-request-failed"))},timeout:ci.get()})}if(null===(r=null===(i=Pn().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Pn().gapi)||void 0===s?void 0:s.load)){const t=Un("iframefcb");return Pn()[t]=()=>{gapi.load?o():n(Ke(e,"network-request-failed"))},Fn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw hi=null,e}))}(e),hi}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const gi={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};class mi{close(){if(this.window)try{this.window.close()}catch(e){}}constructor(e){this.window=e,this.associatedEvent=null}}function vi(e,t,n,i=500,r=600){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},gi),{width:i.toString(),height:r.toString(),top:s,left:o}),l=p().toLowerCase();n&&(a=Dt(l)?"_blank":n),Ot(l)&&(t=t||"http://localhost",c.scrollbars="yes");const h=Object.entries(c).reduce(((e,[t,n])=>`${e}${t}=${n},`),"");if(function(e=p()){var t;return qt(e)&&!!(null===(t=window.navigator)||void 0===t?void 0:t.standalone)}(l)&&"_self"!==a)return function(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new mi(null);const u=window.open(t||"",a,h);Je(u,e,"popup-blocked");try{u.focus()}catch(e){}return new mi(u)}function yi(e,t,n,i,r,s){Je(e.config.authDomain,e,"auth-domain-config-required"),Je(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"9.10.0",eventId:r};if(t instanceof nn){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",N(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof rn){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];return`${function({config:e}){return e.emulator?ot(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${A(a).slice(1)}`}const wi=class{async _openPopup(e,t,n,i){var r;Xe(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return vi(e,yi(e,t,n,tt(),i),kn())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=yi(e,t,n,tt(),i),Pn().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Xe(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await ui(e),n=Pn().gapi;return Je(n,e,"internal-error"),t.open({where:document.body,url:_i(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:pi,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=Ke(e,"network-request-failed"),s=Pn().setTimeout((()=>{i(r)}),di.get());function o(){Pn().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{i(r)}))}))))}(e),n=new ti(e);return t.register("authEvent",(t=>{Je(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),$e(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=oi(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Wt()||At()||qt()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Tn,this._completeRedirectFn=ei,this._overrideRedirectResult=Qn}};var bi;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */bi="Browser",Te(new V("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:s}=n.options;return((e,n)=>{Je(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Je(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:s,clientPlatform:bi,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ht(bi)},o=new Vt(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(et);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Te(new V("auth-internal",(e=>{const t=zt(e.getProvider("auth").getImmediate());return new Ci(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Re("@firebase/auth","0.20.7",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(bi)),Re("@firebase/auth","0.20.7","esm2017");const Ii={apiKey:"AIzaSyCBxxRSUEogARLc21jYUMyG-oQ62S7fczo",authDomain:"filmoteka-9ac74.firebaseapp.com",projectId:"filmoteka-9ac74",storageBucket:"filmoteka-9ac74.appspot.com",messagingSenderId:"294408467658",appId:"1:294408467658:web:cb60f19715353b83323033",measurementId:"G-KN88PKYZVD",databaseURL:"https://filmoteka-9ac74-default-rtdb.europe-west1.firebasedatabase.app"},Ti=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=Ne()){const t=Ee(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ee(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(x(n.getOptions(),null!=t?t:{}))return e;$e(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:wi,persistence:[Ln,Cn,Tn]})}(Pe(Ii));function Ei(e,t){vn(Ti,e,t).then((e=>{e.user})).catch((e=>{e.code,e.message;console.error(e.message)}))}function ki(e,t){yn(Ti,e,t).then((e=>{e.user})).catch((e=>{e.code,e.message}))}const Si=document.querySelector("#email-input"),Pi=document.querySelector("#pwd-input"),Ni=document.querySelector("#register-form"),Ri=document.querySelector("#log-out"),xi=document.querySelector("#login-email-input"),Oi=document.querySelector("#login-pwd-input"),Ai=document.querySelector("#login-form");let Di=null;var Mi,Li,Fi;Ri.addEventListener("click",(function(){B(Ti).signOut()})),Ni.addEventListener("submit",(function(e){e.preventDefault();try{Ei(Si.value,Pi.value),e.currentTarget.reset()}catch(e){console.error(e)}})),Ai.addEventListener("submit",(function(e){e.preventDefault();try{ki(xi.value,Oi.value),e.currentTarget.reset()}catch(e){console.error(e)}})),Mi=e=>{e?(Di=e.uid,console.log(`юзер залогинен, ID = ${e.uid}`)):console.log("нема юзера")},B(Ti).onAuthStateChanged(Mi,Li,Fi);var Ui,qi,ji,Wi=Ui={};function Hi(){throw new Error("setTimeout has not been defined")}function Bi(){throw new Error("clearTimeout has not been defined")}function Vi(e){if(qi===setTimeout)return setTimeout(e,0);if((qi===Hi||!qi)&&setTimeout)return qi=setTimeout,setTimeout(e,0);try{return qi(e,0)}catch(t){try{return qi.call(null,e,0)}catch(t){return qi.call(this,e,0)}}}!function(){try{qi="function"==typeof setTimeout?setTimeout:Hi}catch(e){qi=Hi}try{ji="function"==typeof clearTimeout?clearTimeout:Bi}catch(e){ji=Bi}}();var zi,$i=[],Ki=!1,Gi=-1;function Yi(){Ki&&zi&&(Ki=!1,zi.length?$i=zi.concat($i):Gi=-1,$i.length&&Ji())}function Ji(){if(!Ki){var e=Vi(Yi);Ki=!0;for(var t=$i.length;t;){for(zi=$i,$i=[];++Gi<t;)zi&&zi[Gi].run();Gi=-1,t=$i.length}zi=null,Ki=!1,function(e){if(ji===clearTimeout)return clearTimeout(e);if((ji===Bi||!ji)&&clearTimeout)return ji=clearTimeout,clearTimeout(e);try{ji(e)}catch(t){try{return ji.call(null,e)}catch(t){return ji.call(this,e)}}}(e)}}function Qi(e,t){this.fun=e,this.array=t}function Xi(){}Wi.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];$i.push(new Qi(e,t)),1!==$i.length||Ki||Vi(Ji)},Qi.prototype.run=function(){this.fun.apply(null,this.array)},Wi.title="browser",Wi.browser=!0,Wi.env={},Wi.argv=[],Wi.version="",Wi.versions={},Wi.on=Xi,Wi.addListener=Xi,Wi.once=Xi,Wi.off=Xi,Wi.removeListener=Xi,Wi.removeAllListeners=Xi,Wi.emit=Xi,Wi.prependListener=Xi,Wi.prependOnceListener=Xi,Wi.listeners=function(e){return[]},Wi.binding=function(e){throw new Error("process.binding is not supported")},Wi.cwd=function(){return"/"},Wi.chdir=function(e){throw new Error("process.chdir is not supported")},Wi.umask=function(){return 0};
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nr=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new er(t)}}catch(e){}return new tr},ir=nr("localStorage"),rr=nr("sessionStorage"),sr=new ee("@firebase/database"),or=function(){let e=1;return function(){return e++}}(),ar=function(e){const t=W(e),n=new L;n.update(t);const i=n.digest();return o.encodeByteArray(i)},cr=function(...e){let t="";for(let n=0;n<e.length;n++){const i=e[n];Array.isArray(i)||i&&"object"==typeof i&&"number"==typeof i.length?t+=cr.apply(null,i):t+="object"==typeof i?I(i):i,t+=" "}return t};let lr=null,hr=!0;const ur=function(e,t){i(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(sr.logLevel=G.VERBOSE,lr=sr.log.bind(sr),t&&rr.set("logging_enabled",!0)):"function"==typeof e?lr=e:(lr=null,rr.remove("logging_enabled"))},dr=function(...e){if(!0===hr&&(hr=!1,null===lr&&!0===rr.get("logging_enabled")&&ur(!0)),lr){const t=cr.apply(null,e);lr(t)}},pr=function(e){return function(...t){dr(e,...t)}},fr=function(...e){const t="FIREBASE INTERNAL ERROR: "+cr(...e);sr.error(t)},_r=function(...e){const t=`FIREBASE FATAL ERROR: ${cr(...e)}`;throw sr.error(t),new Error(t)},gr=function(...e){const t="FIREBASE WARNING: "+cr(...e);sr.warn(t)},mr=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},vr=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=kr(e),i=kr(t);return null!==n?null!==i?n-i==0?e.length-t.length:n-i:-1:null!==i?1:e<t?-1:1}},yr=function(e,t){return e===t?0:e<t?-1:1},wr=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+I(t))},br=function(e){if("object"!=typeof e||null===e)return I(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let i=0;i<t.length;i++)0!==i&&(n+=","),n+=I(t[i]),n+=":",n+=br(e[t[i]]);return n+="}",n},Cr=function(e,t){const n=e.length;if(n<=t)return[e];const i=[];for(let r=0;r<n;r+=t)r+t>n?i.push(e.substring(r,n)):i.push(e.substring(r,r+t));return i};function Ir(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const Tr=function(e){i(!mr(e),"Invalid JSON number");const t=1023;let n,r,s,o,a;0===e?(r=0,s=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(o=Math.min(Math.floor(Math.log(e)/Math.LN2),t),r=o+t,s=Math.round(e*Math.pow(2,52-o)-Math.pow(2,52))):(r=0,s=Math.round(e/Math.pow(2,-1074))));const c=[];for(a=52;a;a-=1)c.push(s%2?1:0),s=Math.floor(s/2);for(a=11;a;a-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(n?1:0),c.reverse();const l=c.join("");let h="";for(a=0;a<64;a+=8){let e=parseInt(l.substr(a,8),2).toString(16);1===e.length&&(e="0"+e),h+=e}return h.toLowerCase()};const Er=new RegExp("^-?(0*)\\d{1,10}$"),kr=function(e){if(Er.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},Sr=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw gr("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Pr=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(dr("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',gr(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class xr{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}xr.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ar{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&ir.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,i,r=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=ir.get("host:"+e)||this._host}}function Dr(e,t,n){let r;if(i("string"==typeof t,"typeof type must == string"),i("object"==typeof n,"typeof params must == object"),"websocket"===t)r=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);r=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const s=[];return Ir(n,((e,t)=>{s.push(e+"="+t)})),r+s.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mr{incrementCounter(e,t=1){S(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return h(this.counters_)}constructor(){this.counters_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr={},Fr={};function Ur(e){const t=e.toString();return Lr[t]||(Lr[t]=new Mr),Lr[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _s;class gs extends fs{static get __EMPTY_NODE(){return _s}static set __EMPTY_NODE(e){_s=e}compare(e,t){return vr(e.name,t.name)}isDefinedOn(e){throw r("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return ps.MIN}maxPost(){return new ps("[MAX_NAME]",_s)}makePost(e,t){return i("string"==typeof e,"KeyIndex indexValue must always be a string."),new ps(e,_s)}toString(){return".key"}}const ms=new gs;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function bs(e,t){return vr(e.name,t.name)}function Cs(e,t){return vr(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Is;ws.EMPTY_NODE=new class{copy(e,t,n,i,r){return this}insert(e,t,n){return new ys(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const Ts=function(e){return"number"==typeof e?"number:"+Tr(e):"string:"+e},Es=function(e){if(e.isLeafNode()){const t=e.val();i("string"==typeof t||"number"==typeof t||"object"==typeof t&&S(t,".sv"),"Priority must be a string or number.")}else i(e===Is||e.isEmpty(),"priority of unexpected type.");i(e===Is||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let ks,Ss,Ps;class Ns{static set __childrenNodeConstructor(e){ks=e}static get __childrenNodeConstructor(){return ks}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Ns(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Ns.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return rs(e)?this:".priority"===Qr(e)?this.priorityNode_:Ns.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Ns.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=Qr(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(i(".priority"!==n||1===Xr(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Ns.__childrenNodeConstructor.EMPTY_NODE.updateChild(Zr(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Ts(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?Tr(this.value_):this.value_,this.lazyHash_=ar(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Ns.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Ns.__childrenNodeConstructor?-1:(i(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=Ns.VALUE_TYPE_ORDER.indexOf(t),s=Ns.VALUE_TYPE_ORDER.indexOf(n);return i(r>=0,"Unknown leaf type: "+t),i(s>=0,"Unknown leaf type: "+n),r===s?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=Ns.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,i(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),Es(this.priorityNode_)}}Ns.VALUE_TYPE_ORDER=["object","boolean","number","string"];const Rs=new class extends fs{compare(e,t){const n=e.node.getPriority(),i=t.node.getPriority(),r=n.compareTo(i);return 0===r?vr(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return ps.MIN}maxPost(){return new ps("[MAX_NAME]",new Ns("[PRIORITY-POST]",Ps))}makePost(e,t){const n=Ss(e);return new ps(t,new Ns("[PRIORITY-POST]",n))}toString(){return".priority"}},xs=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ds;const Ms={};class Ls{static get Default(){return i(Ms&&Rs,"ChildrenNode.ts has not been loaded"),Ds=Ds||new Ls({".priority":Ms},{".priority":Rs}),Ds}get(e){const t=P(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ws?t:null}hasIndex(e){return S(this.indexSet_,e.toString())}addIndex(e,t){i(e!==ms,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const s=t.getIterator(ps.Wrap);let o,a=s.getNext();for(;a;)r=r||e.isDefinedOn(a.node),n.push(a),a=s.getNext();o=r?As(n,e.getCompare()):Ms;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const h=Object.assign({},this.indexes_);return h[c]=o,new Ls(h,l)}addToIndexes(e,t){const n=R(this.indexes_,((n,r)=>{const s=P(this.indexSet_,r);if(i(s,"Missing index implementation for "+r),n===Ms){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(ps.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),As(n,s.getCompare())}return Ms}{const i=t.get(e.name);let r=n;return i&&(r=r.remove(new ps(e.name,i))),r.insert(e,e.node)}}));return new Ls(n,this.indexSet_)}removeFromIndexes(e,t){const n=R(this.indexes_,(n=>{if(n===Ms)return n;{const i=t.get(e.name);return i?n.remove(new ps(e.name,i)):n}}));return new Ls(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fs;class Us{static get EMPTY_NODE(){return Fs||(Fs=new Us(new ws(Cs),null,Ls.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Fs}updatePriority(e){return this.children_.isEmpty()?this:new Us(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?Fs:t}}getChild(e){const t=Qr(e);return null===t?this:this.getImmediateChild(t).getChild(Zr(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(i(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new ps(e,t);let i,r;t.isEmpty()?(i=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(n,this.children_)):(i=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(n,this.children_));const s=i.isEmpty()?Fs:this.priorityNode_;return new Us(i,s,r)}}updateChild(e,t){const n=Qr(e);if(null===n)return t;{i(".priority"!==Qr(e)||1===Xr(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(Zr(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,i=0,r=!0;if(this.forEachChild(Rs,((s,o)=>{t[s]=o.val(e),n++,r&&Us.INTEGER_REGEXP_.test(s)?i=Math.max(i,Number(s)):r=!1})),!e&&r&&i<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+Ts(this.getPriority().val())+":"),this.forEachChild(Rs,((t,n)=>{const i=n.hash();""!==i&&(e+=":"+t+":"+i)})),this.lazyHash_=""===e?"":ar(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const i=this.resolveIndex_(n);if(i){const n=i.getPredecessorKey(new ps(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new ps(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new ps(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,ps.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)<0;)n.getNext(),i=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,ps.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)>0;)n.getNext(),i=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===qs?-1:0}withIndex(e){if(e===ms||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Us(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===ms||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(Rs),n=t.getIterator(Rs);let i=e.getNext(),r=n.getNext();for(;i&&r;){if(i.name!==r.name||!i.node.equals(r.node))return!1;i=e.getNext(),r=n.getNext()}return null===i&&null===r}return!1}return!1}}resolveIndex_(e){return e===ms?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&Es(this.priorityNode_),this.children_.isEmpty()&&i(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}Us.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const qs=new class extends Us{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Us.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new ws(Cs),Us.EMPTY_NODE,Ls.Default)}};Object.defineProperties(ps,{MIN:{value:new ps("[MIN_NAME]",Us.EMPTY_NODE)},MAX:{value:new ps("[MAX_NAME]",qs)}}),gs.__EMPTY_NODE=Us.EMPTY_NODE,Ns.__childrenNodeConstructor=Us,Is=qs,function(e){Ps=e}(qs);function js(e,t=null){if(null===e)return Us.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),i(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Ns(e,js(t))}if(e instanceof Array){let n=Us.EMPTY_NODE;return Ir(e,((t,i)=>{if(S(e,t)&&"."!==t.substring(0,1)){const e=js(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(js(t))}{const n=[];let i=!1;if(Ir(e,((e,t)=>{if("."!==e.substring(0,1)){const r=js(t);r.isEmpty()||(i=i||!r.getPriority().isEmpty(),n.push(new ps(e,r)))}})),0===n.length)return Us.EMPTY_NODE;const r=As(n,bs,(e=>e.name),Cs);if(i){const e=As(n,Rs.getCompare());return new Us(r,js(t),new Ls({".priority":e},{".priority":Rs}))}return new Us(r,js(t),Ls.Default)}}!function(e){Ss=e}(js);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hs=new class extends fs{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?vr(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return ps.MIN}maxPost(){return ps.MAX}makePost(e,t){const n=js(e);return new ps(t,n)}toString(){return".value"}},Bs="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",Vs=function(){let e=0;const t=[];return function(n){const r=n===e;let s;e=n;const o=new Array(8);for(s=7;s>=0;s--)o[s]=Bs.charAt(n%64),n=Math.floor(n/64);i(0===n,"Cannot push at time == 0");let a=o.join("");if(r){for(s=11;s>=0&&63===t[s];s--)t[s]=0;t[s]++}else for(s=0;s<12;s++)t[s]=Math.floor(64*Math.random());for(s=0;s<12;s++)a+=Bs.charAt(t[s]);return i(20===a.length,"nextPushId: Length should be 20."),a}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function zs(e){return{type:"value",snapshotNode:e}}function $s(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Ks(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Gs(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs{hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return i(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return i(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return i(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return i(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return i(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Rs}copy(){const e=new Xs;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Rs}}function Zs(e){const t={};if(e.isDefault())return t;let n;return e.index_===Rs?n="$priority":e.index_===Hs?n="$value":e.index_===ms?n="$key":(i(e.index_ instanceof Ws,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=I(n),e.startSet_&&(t.startAt=I(e.indexStartValue_),e.startNameSet_&&(t.startAt+=","+I(e.indexStartName_))),e.endSet_&&(t.endAt=I(e.indexEndValue_),e.endNameSet_&&(t.endAt+=","+I(e.indexEndName_))),e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function eo(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_)),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_)),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Rs&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{so(i,new Yr(t.toString()+"/"+e),n)}))}class oo{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Ir(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Ir(e,((e,i)=>{i>0&&S(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Pr(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new oo(e);const n=1e4+2e4*Math.random();Pr(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function vo(e,t,n,i,s,o){const a=i.filter((e=>e.type===n));a.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw r("Should only compare child_ events.");const i=new ps(t.childName,t.snapshotNode),s=new ps(n.childName,n.snapshotNode);return e.index_.compare(i,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),a.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);s.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function yo(e,t){return{eventCache:e,serverCache:t}}function wo(e,t,n,i){return yo(new go(t,n,i),e.serverCache)}function bo(e,t,n,i){return yo(e.eventCache,new go(t,n,i))}function Co(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Io(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{static empty(){return new ko(new Eo(null))}constructor(e){this.writeTree_=e}}function So(e,t,n){if(rs(t))return new ko(new Eo(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=ss(r,t);return s=s.updateChild(o,n),new ko(e.writeTree_.set(r,s))}{const i=new Eo(n),r=e.writeTree_.setTree(t,i);return new ko(r)}}}function Po(e,t,n){let i=e;return Ir(n,((e,n)=>{i=So(i,is(t,e),n)})),i}function No(e,t){if(rs(t))return ko.empty();{const n=e.writeTree_.setTree(t,new Eo(null));return new ko(n)}}function Ro(e,t){return null!=xo(e,t)}function xo(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ss(n.path,t)):null}function Oo(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Rs,((e,n)=>{t.push(new ps(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new ps(e,n.value))})),t}function Ao(e,t){if(rs(t))return e;{const n=xo(e,t);return new ko(null!=n?new Eo(n):e.writeTree_.subtree(t))}}function Do(e){return e.writeTree_.isEmpty()}function Mo(e,t){return Lo(Jr(),e.writeTree_,t)}function Lo(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?(i(null!==s.value,"Priority writes must always be leaf nodes"),r=s.value):n=Lo(is(e,t),s,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(is(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fo(e,t){return Jo(t,e)}function Uo(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));i(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let s=r.visible,o=!1,a=e.allWrites.length-1;for(;s&&a>=0;){const t=e.allWrites[a];t.visible&&(a>=n&&qo(t,r.path)?s=!1:as(r.path,t.path)&&(o=!0)),a--}if(s){if(o)return function(e){e.visibleWrites=Wo(e.allWrites,jo,Jr()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=No(e.visibleWrites,r.path);else{Ir(r.children,(t=>{e.visibleWrites=No(e.visibleWrites,is(r.path,t))}))}return!0}return!1}function qo(e,t){if(e.snap)return as(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&as(is(e.path,n),t))return!0;return!1}function jo(e){return e.visible}function Wo(e,t,n){let i=ko.empty();for(let s=0;s<e.length;++s){const o=e[s];if(t(o)){const e=o.path;let t;if(o.snap)as(n,e)?(t=ss(n,e),i=So(i,t,o.snap)):as(e,n)&&(t=ss(e,n),i=So(i,Jr(),o.snap.getChild(t)));else{if(!o.children)throw r("WriteRecord should have .snap or .children");if(as(n,e))t=ss(n,e),i=Po(i,t,o.children);else if(as(e,n))if(t=ss(e,n),rs(t))i=Po(i,Jr(),o.children);else{const e=P(o.children,Qr(t));if(e){const n=e.getChild(Zr(t));i=So(i,Jr(),n)}}}}}return i}function Ho(e,t,n,i,r){if(i||r){const s=Ao(e.visibleWrites,t);if(!r&&Do(s))return n;if(r||null!=n||Ro(s,Jr())){const s=function(e){return(e.visible||r)&&(!i||!~i.indexOf(e.writeId))&&(as(e.path,t)||as(t,e.path))};return Mo(Wo(e.allWrites,s,t),n||Us.EMPTY_NODE)}return null}{const i=xo(e.visibleWrites,t);if(null!=i)return i;{const i=Ao(e.visibleWrites,t);if(Do(i))return n;if(null!=n||Ro(i,Jr())){return Mo(i,n||Us.EMPTY_NODE)}return null}}}function Bo(e,t,n,i){return Ho(e.writeTree,e.treePath,t,n,i)}function Vo(e,t){return function(e,t,n){let i=Us.EMPTY_NODE;const r=xo(e.visibleWrites,t);if(r)return r.isLeafNode()||r.forEachChild(Rs,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const r=Ao(e.visibleWrites,t);return n.forEachChild(Rs,((e,t)=>{const n=Mo(Ao(r,new Yr(e)),t);i=i.updateImmediateChild(e,n)})),Oo(r).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}return Oo(Ao(e.visibleWrites,t)).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function zo(e,t,n,r){return function(e,t,n,r,s){i(r||s,"Either existingEventSnap or existingServerSnap must exist");const o=is(t,n);if(Ro(e.visibleWrites,o))return null;{const t=Ao(e.visibleWrites,o);return Do(t)?s.getChild(n):Mo(t,s.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function $o(e,t){return function(e,t){return xo(e.visibleWrites,t)}(e.writeTree,is(e.treePath,t))}function Ko(e,t,n,i,r,s){return function(e,t,n,i,r,s,o){let a;const c=Ao(e.visibleWrites,t),l=xo(c,Jr());if(null!=l)a=l;else{if(null==n)return[];a=Mo(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let c=n.getNext();for(;c&&e.length<r;)0!==t(c,i)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,r,s)}function Go(e,t,n){return function(e,t,n,i){const r=is(t,n),s=xo(e.visibleWrites,r);if(null!=s)return s;if(i.isCompleteForChild(n))return Mo(Ao(e.visibleWrites,r),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Yo(e,t){return Jo(is(e.treePath,t),e.writeTree)}function Jo(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xo=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Zo{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new go(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Go(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Io(this.viewCache_),r=Ko(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pa,fa;class _a{constructor(){this.views=new Map}}function ga(e,t,n,r){const s=t.source.queryId;if(null!==s){const o=e.views.get(s);return i(null!=o,"SyncTree gave us an op for an invalid query."),ua(o,t,n,r)}{let i=[];for(const s of e.views.values())i=i.concat(ua(s,t,n,r));return i}}function ma(e,t,n,i,r){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=Bo(n,r?i:null),s=!1;e?s=!0:i instanceof Us?(e=Vo(n,i),s=!1):(e=Us.EMPTY_NODE,s=!1);const o=yo(new go(e,s,!1),new go(i,r,!1));return new aa(t,o)}return o}function va(e,t,n,i,r,s){const o=ma(e,t,i,r,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(Rs,((e,t)=>{i.push($s(e,t))}));return n.isFullyInitialized()&&i.push(zs(n.getNode())),da(e,i,n.getNode(),t)}(o,n)}function ya(e,t,n,r){const s=t._queryIdentifier,o=[];let a=[];const c=Ta(e);if("default"===s)for(const[t,i]of e.views.entries())a=a.concat(ha(i,n,r)),la(i)&&(e.views.delete(t),i.query._queryParams.loadsAllData()||o.push(i.query));else{const t=e.views.get(s);t&&(a=a.concat(ha(t,n,r)),la(t)&&(e.views.delete(s),t.query._queryParams.loadsAllData()||o.push(t.query)))}return c&&!Ta(e)&&o.push(new(i(pa,"Reference.ts has not been loaded"),pa)(t._repo,t._path)),{removed:o,events:a}}function wa(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function ba(e,t){let n=null;for(const i of e.views.values())n=n||ca(i,t);return n}function Ca(e,t){if(t._queryParams.loadsAllData())return Ea(e);{const n=t._queryIdentifier;return e.views.get(n)}}function Ia(e,t){return null!=Ca(e,t)}function Ta(e){return null!=Ea(e)}function Ea(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ka=1;class Sa{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Eo(null),this.pendingWriteTree_={visibleWrites:ko.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Pa(e,t,n,r,s){return function(e,t,n,r,s){i(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===s&&(s=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:s}),s&&(e.visibleWrites=So(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,s),s?Ma(e,new fo({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Na(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Uo(e.pendingWriteTree_,t)){let t=new Eo(null);return null!=i.snap?t=t.set(Jr(),!0):Ir(i.children,(e=>{t=t.set(new Yr(e),!0)})),Ma(e,new uo(i.path,t,n))}return[]}function Ra(e,t,n){return Ma(e,new fo({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function xa(e,t,n,i,r=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||Ia(o,t))){const c=ya(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const l=c.removed;if(a=c.events,!r){const n=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(s,((e,t)=>Ta(t)));if(n&&!r){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Ta(t)){return[Ea(t)]}{let e=[];return t&&(e=wa(t)),Ir(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=Ua(e,i);e.listenProvider_.startListening(Va(r),qa(e,r),s.hashFn,s.onComplete)}}}if(!r&&l.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(Va(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(ja(t));e.listenProvider_.stopListening(Va(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ja(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return a}function Oa(e,t,n,i){const r=Wa(e,i);if(null!=r){const i=Ha(r),s=i.path,o=i.queryId,a=ss(s,t);return Ba(e,s,new fo(ho(o),a,n))}return[]}function Aa(e,t,n,r=!1){const s=t._path;let o=null,a=!1;e.syncPointTree_.foreachOnPath(s,((e,t)=>{const n=ss(e,s);o=o||ba(t,n),a=a||Ta(t)}));let c,l=e.syncPointTree_.get(s);if(l?(a=a||Ta(l),o=o||ba(l,Jr())):(l=new _a,e.syncPointTree_=e.syncPointTree_.set(s,l)),null!=o)c=!0;else{c=!1,o=Us.EMPTY_NODE;e.syncPointTree_.subtree(s).foreachChild(((e,t)=>{const n=ba(t,Jr());n&&(o=o.updateImmediateChild(e,n))}))}const h=Ia(l,t);if(!h&&!t._queryParams.loadsAllData()){const n=ja(t);i(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=ka++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let u=va(l,t,n,Fo(e.pendingWriteTree_,s),o,c);if(!h&&!a&&!r){const n=Ca(l,t);u=u.concat(function(e,t,n){const r=t._path,s=qa(e,t),o=Ua(e,n),a=e.listenProvider_.startListening(Va(t),s,o.hashFn,o.onComplete),c=e.syncPointTree_.subtree(r);if(s)i(!Ta(c.value),"If we're adding a query, it shouldn't be shadowed");else{const t=c.fold(((e,t,n)=>{if(!rs(e)&&t&&Ta(t))return[Ea(t).query];{let e=[];return t&&(e=e.concat(wa(t).map((e=>e.query)))),Ir(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(Va(i),qa(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return u}function Da(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=ba(n,ss(e,t));if(i)return i}));return Ho(i,t,r,n,!0)}function Ma(e,t){return La(t,e.syncPointTree_,null,Fo(e.pendingWriteTree_,Jr()))}function La(e,t,n,i){if(rs(e.path))return Fa(e,t,n,i);{const r=t.get(Jr());null==n&&null!=r&&(n=ba(r,Jr()));let s=[];const o=Qr(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=Yo(i,o);s=s.concat(La(a,c,e,t))}return r&&(s=s.concat(ga(r,e,i,n))),s}}function Fa(e,t,n,i){const r=t.get(Jr());null==n&&null!=r&&(n=ba(r,Jr()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=Yo(i,t),c=e.operationForChild(t);c&&(s=s.concat(Fa(c,r,o,a)))})),r&&(s=s.concat(ga(r,e,i,n))),s}function Ua(e,t){const n=t.query,i=qa(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||Us.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=Wa(e,n);if(i){const n=Ha(i),r=n.path,s=n.queryId,o=ss(r,t);return Ba(e,r,new po(ho(s),o))}return[]}(e,n._path,i):function(e,t){return Ma(e,new po({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return xa(e,n,null,i)}}}}function qa(e,t){const n=ja(t);return e.queryToTagMap.get(n)}function ja(e){return e._path.toString()+"$"+e._queryIdentifier}function Wa(e,t){return e.tagToQueryMap.get(t)}function Ha(e){const t=e.indexOf("$");return i(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Yr(e.substr(0,t))}}function Ba(e,t,n){const r=e.syncPointTree_.get(t);i(r,"Missing sync point for query tag that we're tracking");return ga(r,n,Fo(e.pendingWriteTree_,t),null)}function Va(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(i(fa,"Reference.ts has not been loaded"),fa)(e._repo,e._path):e}class za{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new za(t)}node(){return this.node_}constructor(e){this.node_=e}}class $a{getImmediateChild(e){const t=is(this.path_,e);return new $a(this.syncTree_,t)}node(){return Da(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const Ka=function(e,t,n){return e&&"object"==typeof e?(i(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Ga(e[".sv"],t,n):"object"==typeof e[".sv"]?Ya(e[".sv"],t):void i(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Ga=function(e,t,n){if("timestamp"===e)return n.timestamp;i(!1,"Unexpected server value: "+e)},Ya=function(e,t,n){e.hasOwnProperty("increment")||i(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&i(!1,"Unexpected increment value: "+r);const s=t.node();if(i(null!=s,"Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return r;const o=s.getValue();return"number"!=typeof o?r:o+r},Ja=function(e,t,n,i){return Xa(t,new $a(n,e),i)},Qa=function(e,t,n){return Xa(e,new za(t),n)};function Xa(e,t,n){const i=e.getPriority().val(),r=Ka(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=Ka(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new Ns(s,js(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new Ns(r))),i.forEachChild(Rs,((e,i)=>{const r=Xa(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class mc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function vc(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||os(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function yc(e,t,n){vc(e,n),bc(e,(e=>os(e,t)))}function wc(e,t,n){vc(e,n),bc(e,(e=>as(e,t)||as(t,e)))}function bc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Cc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Cc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();lr&&dr("event: "+n.toString()),Sr(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ic{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new mc,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=io(),this.transactionQueueTree_=new Za,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function Tc(e,t,n){if(e.stats_=Ur(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new to(e.repoInfo_,((t,n,i,r)=>{Sc(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Pc(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{I(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new ds(e.repoInfo_,t,((t,n,i,r)=>{Sc(e,t,n,i,r)}),(t=>{Pc(e,t)}),(t=>{!function(e,t){Ir(t,((t,n)=>{Nc(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return Fr[n]||(Fr[n]=t()),Fr[n]}(e.repoInfo_,(()=>new ao(e.stats_,e.server_))),e.infoData_=new no,e.infoSyncTree_=new Sa({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Ra(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),Nc(e,"connected",!1),e.serverSyncTree_=new Sa({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);wc(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Ec(e){const t=e.infoData_.getNode(new Yr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function kc(e){return(t=(t={timestamp:Ec(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Sc(e,t,n,i,r){e.dataUpdateCount++;const s=new Yr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=R(n,(e=>js(e)));o=function(e,t,n,i){const r=Wa(e,i);if(r){const i=Ha(r),s=i.path,o=i.queryId,a=ss(s,t),c=Eo.fromObject(n);return Ba(e,s,new _o(ho(o),a,c))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=js(n);o=Oa(e.serverSyncTree_,s,t,r)}else if(i){const t=R(n,(e=>js(e)));o=function(e,t,n){const i=Eo.fromObject(n);return Ma(e,new _o({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=js(n);o=Ra(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=Uc(e,s)),wc(e.eventQueue_,a,o)}function Pc(e,t){Nc(e,"connected",t),!1===t&&function(e){Dc(e,"onDisconnectEvents");const t=kc(e),n=io();so(e.onDisconnect_,Jr(),((i,r)=>{const s=Ja(i,r,e.serverSyncTree_,t);ro(n,i,s)}));let i=[];so(n,Jr(),((t,n)=>{i=i.concat(Ra(e.serverSyncTree_,t,n));const r=Bc(e,t);Uc(e,r)})),e.onDisconnect_=io(),wc(e.eventQueue_,Jr(),i)}(e)}function Nc(e,t,n){const i=new Yr("/.info/"+t),r=js(n);e.infoData_.updateSnapshot(i,r);const s=Ra(e.infoSyncTree_,i,r);wc(e.eventQueue_,i,s)}function Rc(e){return e.nextWriteId_++}function xc(e,t,n,i,r){Dc(e,"set",{path:t.toString(),value:n,priority:i});const s=kc(e),o=js(n,i),a=Da(e.serverSyncTree_,t),c=Qa(o,a,s),l=Rc(e),h=Pa(e.serverSyncTree_,t,c,l,!0);vc(e.eventQueue_,h),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||gr("set at "+t+" failed: "+n);const o=Na(e.serverSyncTree_,l,!s);wc(e.eventQueue_,t,o),Mc(e,r,n,i)}));const u=Bc(e,t);Uc(e,u),wc(e.eventQueue_,u,[])}function Oc(e,t,n){let i;i=".info"===Qr(t._path)?xa(e.infoSyncTree_,t,n):xa(e.serverSyncTree_,t,n),yc(e.eventQueue_,t._path,i)}function Ac(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Dc(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),dr(n,...t)}function Mc(e,t,n,i){t&&Sr((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}function Lc(e,t,n){return Da(e.serverSyncTree_,t,n)||Us.EMPTY_NODE}function Fc(e,t=e.transactionQueueTree_){if(t||Hc(e,t),tc(t)){const n=jc(e,t);i(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),s=Lc(e,t,r);let o=s;const a=s.hash();for(let e=0;e<n.length;e++){const r=n[e];i(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const s=ss(t,r.path);o=o.updateChild(s,r.currentOutputSnapshotRaw)}const c=o.val(!0),l=t;e.server_.put(l.toString(),c,(i=>{Dc(e,"transaction put response",{path:l.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(Na(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Hc(e,ec(e.transactionQueueTree_,t)),Fc(e,e.transactionQueueTree_),wc(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)Sr(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{gr("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}Uc(e,t)}}),a)}(e,oc(t),n)}else ic(t)&&rc(t,(t=>{Fc(e,t)}))}function Uc(e,t){const n=qc(e,t),r=oc(n);return function(e,t,n){if(0===t.length)return;const r=[];let s=[];const o=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let c=0;c<t.length;c++){const l=t[c],h=ss(n,l.path);let u,d=!1;if(i(null!==h,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)d=!0,u=l.abortReason,s=s.concat(Na(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)d=!0,u="maxretry",s=s.concat(Na(e.serverSyncTree_,l.currentWriteId,!0));else{const n=Lc(e,l.path,o);l.currentInputSnapshot=n;const i=t[c].update(n.val());if(void 0!==i){pc("transaction failed: Data returned ",i,l.path);let t=js(i);"object"==typeof i&&null!=i&&S(i,".priority")||(t=t.updatePriority(n.getPriority()));const r=l.currentWriteId,a=kc(e),c=Qa(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=Rc(e),o.splice(o.indexOf(r),1),s=s.concat(Pa(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),s=s.concat(Na(e.serverSyncTree_,r,!0))}else d=!0,u="nodata",s=s.concat(Na(e.serverSyncTree_,l.currentWriteId,!0))}wc(e.eventQueue_,n,s),s=[],d&&(t[c].status=2,a=t[c].unwatcher,setTimeout(a,Math.floor(0)),t[c].onComplete&&("nodata"===u?r.push((()=>t[c].onComplete(null,!1,t[c].currentInputSnapshot))):r.push((()=>t[c].onComplete(new Error(u),!1,null)))))}var a;Hc(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)Sr(r[e]);Fc(e,e.transactionQueueTree_)}(e,jc(e,n),r),r}function qc(e,t){let n,i=e.transactionQueueTree_;for(n=Qr(t);null!==n&&void 0===tc(i);)i=ec(i,n),n=Qr(t=Zr(t));return i}function jc(e,t){const n=[];return Wc(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function Wc(e,t,n){const i=tc(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);rc(t,(t=>{Wc(e,t,n)}))}function Hc(e,t){const n=tc(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,nc(t,n.length>0?n:void 0)}rc(t,(t=>{Hc(e,t)}))}function Bc(e,t){const n=oc(qc(e,t)),i=ec(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{Vc(e,t)})),Vc(e,i),sc(i,(t=>{Vc(e,t)})),n}function Vc(e,t){const n=tc(t);if(n){const r=[];let s=[],o=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(i(o===t-1,"All SENT items should be at beginning of queue."),o=t,n[t].status=3,n[t].abortReason="set"):(i(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),s=s.concat(Na(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?nc(t,void 0):n.length=o+1,wc(e.eventQueue_,oc(t),s);for(let e=0;e<r.length;e++)Sr(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const al={};let cl=!1;function ll(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||_r("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),dr("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=zc(s,r),l=c.repoInfo;void 0!==Ui&&Ui.env&&(a=Ui.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=zc(s,r),l=c.repoInfo):o=!c.repoInfo.secure;const h=r&&o?new xr(xr.OWNER):new Rr(e.name,e.options,t);gc("Invalid Firebase Database URL",c),rs(c.path)||_r("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=al[t.name];r||(r={},al[t.name]=r);let s=r[e.toURLString()];s&&_r("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new Ic(e,cl,n,i),r[e.toURLString()]=s,s}(l,e,h,new Nr(e.name,n));return new hl(u,e)}class hl{get _repo(){return this._instanceStarted||(Tc(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Qc(this._repo,Jr())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=al[t];n&&n[e.key]===e||_r(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Ac(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&_r("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}ds.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},ds.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Zi="9.10.0",Te(new V("database",((e,{instanceIdentifier:t})=>ll(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Re("@firebase/database","0.13.6",e),Re("@firebase/database","0.13.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
