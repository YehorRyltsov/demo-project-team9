 ...
 * limitations under the License.
 */
function(e=ze()){const t=Me(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Me(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(q(n.getOptions(),null!=t?t:{}))return e;tt(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Si,persistence:[Vn,Ln,An]})}(Fe(Pi));function Ru(e,n){Tn(Su,e,n).then((n=>{t(l).Notify.success(`Yahoooo!!!! Welcome ${e}`);n.user})).catch((e=>{e.code,e.message;console.error(e.message),t(l).Notify.failure("We cant create user likes this")}))}function Lu(e,n){En(Su,e,n).then((e=>{t(l).Notify.success("Login success");e.user})).catch((e=>{t(l).Notify.failure("Login failure")}))}function Pu(){J(Su).signOut(),t(l).Notify.info("You just logOut"),Tu(1)}const Au=document.querySelector(".header"),Mu=document.querySelector(".search-form"),Ou=document.querySelector(".home-link"),Du=document.querySelector(".library-link"),Fu=document.querySelector(".library-btn__wrap"),zu=document.querySelector(".gallery-films");const Wu=document.querySelector("#email-input"),qu=document.querySelector("#pwd-input"),Uu=document.querySelector("#second-pwd-input"),Bu=document.querySelector("#register-form"),ju=document.querySelector('button[data-id="log-out"]'),Hu=document.querySelector("#login-email-input"),Vu=document.querySelector("#login-pwd-input"),$u=document.querySelector("#login-form"),Xu=(document.querySelector("#form-login-btn"),document.querySelector("#form-signup-btn")),Ku=document.querySelector(".form-register-svg.pwdInput"),Yu=document.querySelector(".form-register-svg.pwdRepeatInput"),Gu=document.querySelector('button[data-id="log-in"]'),Qu=document.querySelector("[data-log-modal]"),Ju=document.querySelector("body");let Zu=null;var eh,th,nh;function ih(e){const t=e.currentTarget,n=qu.value;t.value===n?(qu.classList.add("checked"),Uu.classList.add("checked"),Ku.classList.add("checked"),Yu.classList.add("checked"),Xu.disabled=!1):(rh(),Xu.disabled=!0)}function rh(){qu.classList.remove("checked"),Uu.classList.remove("checked"),Ku.classList.remove("checked"),Yu.classList.remove("checked")}ju.addEventListener("click",(function(){Pu(),Fu.classList.add("visually-hidden"),Mu.classList.remove("visually-hidden"),Ou.classList.add("current"),Du.classList.remove("current"),Au.classList.remove("header__my-library-bg"),Au.classList.add("home-header-bg"),zu.classList.add("gallery-films"),Tu(1)})),Bu.addEventListener("submit",(function(e){e.preventDefault(),rh();try{Ru(Wu.value,qu.value),e.currentTarget.reset()}catch(t){e.currentTarget.reset()}})),$u.addEventListener("submit",(function(e){e.preventDefault();try{Lu(Hu.value,Vu.value),e.currentTarget.reset()}catch(e){}})),eh=e=>{e?(Gu.classList.add("visually-hidden"),ju.classList.remove("visually-hidden"),Qu.classList.add("is-hidden"),Ju.classList.remove("no-scroll"),Zu=e.uid):(Zu=null,Gu.classList.remove("visually-hidden"),ju.classList.add("visually-hidden"))},J(Su).onAuthStateChanged(eh,th,nh);var sh={};sh=function e(t,n,i){function r(o,a){if(!n[o]){if(!t[o]){var l=void 0;if(!a&&l)return l(o,!0);if(s)return s(o,!0);var c=new Error("Cannot find module '"+o+"'");throw c.code="MODULE_NOT_FOUND",c}var u=n[o]={exports:{}};t[o][0].call(u.exports,(function(e){return r(t[o][1][e]||e)}),u,u.exports,e,t,n,i)}return n[o].exports}for(var s=void 0,o=0;o<i.length;o++)r(i[o]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var i=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},s=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=s,n.create=function(e,t){var n=function(e,t){var n=i('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),s=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return s.appendChild(e)}));var o=r(s,"IMG"),a=r(s,"VIDEO"),l=r(s,"IFRAME");return!0===o&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===l&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(i(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),o=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===s(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&o()}));var a={element:function(){return n},visible:function(){return s(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:o};return a}},{}]},{},[1])(1);var oh;oh=new URL(s("kyEFX").resolve("gOLlt"),import.meta.url).toString();var ah;ah=new URL(s("kyEFX").resolve("iTfR5"),import.meta.url).toString();var lh;lh=new URL(s("kyEFX").resolve("7nYPu"),import.meta.url).toString();var ch;ch=new URL(s("kyEFX").resolve("fkcxk"),import.meta.url).toString();var uh;uh=new URL(s("kyEFX").resolve("acMhR"),import.meta.url).toString();var hh;hh=new URL(s("kyEFX").resolve("cshoN"),import.meta.url).toString();var dh;dh=new URL(s("kyEFX").resolve("jOnoa"),import.meta.url).toString();var ph;ph=new URL(s("kyEFX").resolve("eQ6pA"),import.meta.url).toString();var fh;fh=new URL(s("kyEFX").resolve("em9Db"),import.meta.url).toString();var mh;mh=new URL(s("kyEFX").resolve("6n6Lh"),import.meta.url).toString();var gh;gh=new URL(s("kyEFX").resolve("eqJcO"),import.meta.url).toString();var yh;yh=new URL(s("kyEFX").resolve("56Ciu"),import.meta.url).toString();const vh=`<div class="modal-team" id="modalTeam"><div class="team-card">\n    <img src="${t(oh)}" alt="Yegor" class="team-image">\n    <p class="team-name">Yegor</p>\n    <p class="team-role">'Developer, TeamLead'</p>\n    <a href="https://github.com/YehorRyltsov" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#github"></use>\n    </svg></a>\n    <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ah)}" alt="Valerii" class="team-image">\n    <p class="team-name">Valerii</p>\n    <p class="team-role">'Developer, Scram master'</p>\n    <a href="https://github.com/Valerii-Postrybailo" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(lh)}" alt="Khrystyna" class="team-image">\n    <p class="team-name">Khrystyna</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/kmykolaichuk" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/khrystyna-mykolaichuk-29275b163" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ch)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/NataliiaKulchytska" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(uh)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Nataliphoenix" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(hh)}" alt="Sergei" class="team-image">\n    <p class="team-name">Sergei</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/seroga213" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(dh)}" alt="Vitalii" class="team-image">\n    <p class="team-name">Vitaliy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/VitaliiMazur" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/vitalii-mazur-5612b9237" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ph)}" alt=">Yuriy" class="team-image">\n    <p class="team-name">Yura</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Shavursky" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(mh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Scumsy" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(fh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/bigmandarine" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(gh)}" alt="Arseniy" class="team-image">\n    <p class="team-name">Arseniy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/arseniy-grinev" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(yh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(yh)}#in"></use>\n    </svg></a>\n</div>\n</div>\n`,_h=document.querySelector("[data-modal-open-team]"),bh=document.querySelector("body");document.querySelector("#modalTeam");_h.addEventListener("click",(function(e){e.preventDefault(),wh.show(),window.addEventListener("keydown",xh),bh.classList.add("noScroll"),xh(e)}));const wh=sh.create(vh,{onClose:e=>{bh.classList.remove("noScroll")}});function xh(e){"Escape"===e.code&&(wh.close(),window.removeEventListener("keydown",xh))}const kh=document.querySelector(".scroll-top");kh.addEventListener("click",(function(e){window.scrollTo({top:0,behavior:"smooth"}),Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600)})),window.addEventListener("scroll",(function(e){window.pageYOffset<100?kh.classList.add("is-hidden"):kh.classList.remove("is-hidden")}));Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(400),t(l).Notify.init({position:"center-top"});
//# sourceMappingURL=index.8c3dfea0.js.map
