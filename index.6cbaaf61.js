 ...
 * limitations under the License.
 */
function(e=ze()){const t=Me(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Me(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(U(n.getOptions(),null!=t?t:{}))return e;tt(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Si,persistence:[Vn,Ln,An]})}(Fe(Pi));function or(e,n){Tn(sr,e,n).then((n=>{t(l).Notify.success(`Yahoooo!!!! Welcome ${e}`);n.user})).catch((e=>{e.code,e.message;console.error(e.message),t(l).Notify.failure("We cant create user likes this")}))}function ar(e,n){En(sr,e,n).then((e=>{t(l).Notify.success("Login success");e.user})).catch((e=>{t(l).Notify.failure("Login failure")}))}function lr(){J(sr).signOut(),t(l).Notify.info("You just logOut"),ir(1)}const cr=document.querySelector(".header"),ur=document.querySelector(".search-form"),hr=document.querySelector(".home-link"),dr=document.querySelector(".library-link"),pr=document.querySelector(".library-btn__wrap"),fr=document.querySelector(".gallery-films");const mr=document.querySelector("#email-input"),gr=document.querySelector("#pwd-input"),yr=document.querySelector("#second-pwd-input"),vr=document.querySelector("#register-form"),_r=document.querySelector('button[data-id="log-out"]'),br=document.querySelector("#login-email-input"),wr=document.querySelector("#login-pwd-input"),xr=document.querySelector("#login-form"),kr=(document.querySelector("#form-login-btn"),document.querySelector("#form-signup-btn")),Cr=document.querySelector('button[data-id="log-in"]'),Ir=document.querySelector("[data-log-modal]"),Nr=document.querySelector("body");let Tr=null;var Er,Sr,Rr;function Lr(e){const t=e.currentTarget,n=gr.value;t.value===n?(gr.classList.add("checked"),yr.classList.add("checked"),kr.disabled=!1):(Pr(),kr.disabled=!0)}function Pr(){gr.classList.remove("checked"),yr.classList.remove("checked")}_r.addEventListener("click",(function(){lr(),pr.classList.add("visually-hidden"),ur.classList.remove("visually-hidden"),hr.classList.add("current"),dr.classList.remove("current"),cr.classList.remove("header__my-library-bg"),cr.classList.add("home-header-bg"),fr.classList.add("gallery-films"),ir(1)})),vr.addEventListener("submit",(function(e){e.preventDefault(),Pr();try{or(mr.value,gr.value),e.currentTarget.reset()}catch(t){e.currentTarget.reset()}})),xr.addEventListener("submit",(function(e){e.preventDefault();try{ar(br.value,wr.value),e.currentTarget.reset()}catch(e){}})),Er=e=>{e?(Cr.classList.add("visually-hidden"),_r.classList.remove("visually-hidden"),Ir.classList.add("is-hidden"),Nr.classList.remove("no-scroll"),Tr=e.uid,console.log(`юзер залогинен, ID = ${e.uid}`)):(Tr=null,Cr.classList.remove("visually-hidden"),_r.classList.add("visually-hidden"))},J(sr).onAuthStateChanged(Er,Sr,Rr);var Ar,Mr,Or,Dr=Ar={};function Fr(){throw new Error("setTimeout has not been defined")}function zr(){throw new Error("clearTimeout has not been defined")}function Wr(e){if(Mr===setTimeout)return setTimeout(e,0);if((Mr===Fr||!Mr)&&setTimeout)return Mr=setTimeout,setTimeout(e,0);try{return Mr(e,0)}catch(t){try{return Mr.call(null,e,0)}catch(t){return Mr.call(this,e,0)}}}!function(){try{Mr="function"==typeof setTimeout?setTimeout:Fr}catch(e){Mr=Fr}try{Or="function"==typeof clearTimeout?clearTimeout:zr}catch(e){Or=zr}}();var Ur,qr=[],Br=!1,jr=-1;function Hr(){Br&&Ur&&(Br=!1,Ur.length?qr=Ur.concat(qr):jr=-1,qr.length&&Vr())}function Vr(){if(!Br){var e=Wr(Hr);Br=!0;for(var t=qr.length;t;){for(Ur=qr,qr=[];++jr<t;)Ur&&Ur[jr].run();jr=-1,t=qr.length}Ur=null,Br=!1,function(e){if(Or===clearTimeout)return clearTimeout(e);if((Or===zr||!Or)&&clearTimeout)return Or=clearTimeout,clearTimeout(e);try{Or(e)}catch(t){try{return Or.call(null,e)}catch(t){return Or.call(this,e)}}}(e)}}function $r(e,t){this.fun=e,this.array=t}function Xr(){}Dr.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];qr.push(new $r(e,t)),1!==qr.length||Br||Wr(Vr)},$r.prototype.run=function(){this.fun.apply(null,this.array)},Dr.title="browser",Dr.browser=!0,Dr.env={},Dr.argv=[],Dr.version="",Dr.versions={},Dr.on=Xr,Dr.addListener=Xr,Dr.once=Xr,Dr.off=Xr,Dr.removeListener=Xr,Dr.removeAllListeners=Xr,Dr.emit=Xr,Dr.prependListener=Xr,Dr.prependOnceListener=Xr,Dr.listeners=function(e){return[]},Dr.binding=function(e){throw new Error("process.binding is not supported")},Dr.cwd=function(){return"/"},Dr.chdir=function(e){throw new Error("process.chdir is not supported")},Dr.umask=function(){return 0};
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return D(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}constructor(){this.cache_={},this.isInMemoryStorage=!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new Yr(t)}}catch(e){}return new Gr},Jr=Qr("localStorage"),Zr=Qr("sessionStorage"),es=new ce("@firebase/database"),ts=function(){let e=1;return function(){return e++}}(),ns=function(e){const t=G(e),n=new V;n.update(t);const i=n.digest();return m.encodeByteArray(i)},is=function(...e){let t="";for(let n=0;n<e.length;n++){const i=e[n];Array.isArray(i)||i&&"object"==typeof i&&"number"==typeof i.length?t+=is.apply(null,i):t+="object"==typeof i?P(i):i,t+=" "}return t};let rs=null,ss=!0;const os=function(e,t){d(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(es.logLevel=ie.VERBOSE,rs=es.log.bind(es),t&&Zr.set("logging_enabled",!0)):"function"==typeof e?rs=e:(rs=null,Zr.remove("logging_enabled"))},as=function(...e){if(!0===ss&&(ss=!1,null===rs&&!0===Zr.get("logging_enabled")&&os(!0)),rs){const t=is.apply(null,e);rs(t)}},ls=function(e){return function(...t){as(e,...t)}},cs=function(...e){const t="FIREBASE INTERNAL ERROR: "+is(...e);es.error(t)},us=function(...e){const t=`FIREBASE FATAL ERROR: ${is(...e)}`;throw es.error(t),new Error(t)},hs=function(...e){const t="FIREBASE WARNING: "+is(...e);es.warn(t)},ds=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},ps=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=ws(e),i=ws(t);return null!==n?null!==i?n-i==0?e.length-t.length:n-i:-1:null!==i?1:e<t?-1:1}},fs=function(e,t){return e===t?0:e<t?-1:1},ms=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+P(t))},gs=function(e){if("object"!=typeof e||null===e)return P(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let i=0;i<t.length;i++)0!==i&&(n+=","),n+=P(t[i]),n+=":",n+=gs(e[t[i]]);return n+="}",n},ys=function(e,t){const n=e.length;if(n<=t)return[e];const i=[];for(let r=0;r<n;r+=t)r+t>n?i.push(e.substring(r,n)):i.push(e.substring(r,r+t));return i};function vs(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const _s=function(e){d(!ds(e),"Invalid JSON number");const t=1023;let n,i,r,s,o;0===e?(i=0,r=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(s=Math.min(Math.floor(Math.log(e)/Math.LN2),t),i=s+t,r=Math.round(e*Math.pow(2,52-s)-Math.pow(2,52))):(i=0,r=Math.round(e/Math.pow(2,-1074))));const a=[];for(o=52;o;o-=1)a.push(r%2?1:0),r=Math.floor(r/2);for(o=11;o;o-=1)a.push(i%2?1:0),i=Math.floor(i/2);a.push(n?1:0),a.reverse();const l=a.join("");let c="";for(o=0;o<64;o+=8){let e=parseInt(l.substr(o,8),2).toString(16);1===e.length&&(e="0"+e),c+=e}return c.toLowerCase()};const bs=new RegExp("^-?(0*)\\d{1,10}$"),ws=function(e){if(bs.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},xs=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw hs("Exception was thrown by user callback.",t),e}),Math.floor(0))}},ks=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Is{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(as("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',hs(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class Ns{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}Ns.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ts=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Es{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Jr.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,i,r=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Jr.get("host:"+e)||this._host}}function Ss(e,t,n){let i;if(d("string"==typeof t,"typeof type must == string"),d("object"==typeof n,"typeof params must == object"),"websocket"===t)i=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);i=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const r=[];return vs(n,((e,t)=>{r.push(e+"="+t)})),i+r.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{incrementCounter(e,t=1){D(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return _(this.counters_)}constructor(){this.counters_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ls={},Ps={};function As(e){const t=e.toString();return Ls[t]||(Ls[t]=new Rs),Ls[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ms{closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&xs((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fs=null;"undefined"!=typeof MozWebSocket?Fs=MozWebSocket:"undefined"!=typeof WebSocket&&(Fs=WebSocket);class zs{static connectionURL_(e,t,n,i,r){const s={v:"5"};return!T()&&"undefined"!=typeof location&&location.hostname&&Ts.test(location.hostname)&&(s.r="f"),t&&(s.s=t),n&&(s.ls=n),i&&(s.ac=i),r&&(s.p=r),Ss(e,"websocket",s)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Jr.set("previous_websocket_failure",!0);try{let e;if(T()){const t=this.nodeAdmin?"AdminNode":"Node";e={headers:{"User-Agent":`Firebase/5/${Kr}/${Ar.platform}/${t}`,"X-Firebase-GMPID":this.applicationId||""}},this.authToken&&(e.headers.Authorization=`Bearer ${this.authToken}`),this.appCheckToken&&(e.headers["X-Firebase-AppCheck"]=this.appCheckToken);const n={},i=0===this.connURL.indexOf("wss://")?n.HTTPS_PROXY||n.https_proxy:n.HTTP_PROXY||n.http_proxy;i&&(e.proxy={origin:i})}this.mySock=new Fs(this.connURL,[],e)}catch(e){this.log_("Error instantiating WebSocket.");const t=e.message||e.data;return t&&this.log_(t),void this.onClosed_()}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=e=>{this.handleIncomingFrame(e)},this.mySock.onerror=e=>{this.log_("WebSocket error.  Closing connection.");const t=e.message||e.data;t&&this.log_(t),this.onClosed_()}}start(){}static forceDisallow(){zs.forceDisallow_=!0}static isAvailable(){let e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,n=navigator.userAgent.match(t);n&&n.length>1&&parseFloat(n[1])<4.4&&(e=!0)}return!e&&null!==Fs&&!zs.forceDisallow_}static previouslyFailed(){return Jr.isInMemoryStorage||!0===Jr.get("previous_websocket_failure")}markConnectionHealthy(){Jr.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const e=this.frames.join("");this.frames=null;const t=L(e);this.onMessage(t)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(d(null===this.frames,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(null===this.mySock)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),null!==this.frames)this.appendFrame_(t);else{const e=this.extractFrameCount_(t);null!==e&&this.appendFrame_(e)}}send(e){this.resetKeepAlive();const t=P(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=ys(t,16384);n.length>1&&this.sendString_(String(n.length));for(let e=0;e<n.length;e++)this.sendString_(n[e])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval((()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()}),Math.floor(45e3))}sendString_(e){try{this.mySock.send(e)}catch(e){this.log_("Exception thrown from WebSocket.send():",e.message||e.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}constructor(e,t,n,i,r,s,o){this.connId=e,this.applicationId=n,this.appCheckToken=i,this.authToken=r,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=ls(this.connId),this.stats_=As(t),this.connURL=zs.connectionURL_(t,s,o,i,n),this.nodeAdmin=t.nodeAdmin}}zs.responsesRequiredToBeHealthy=2,zs.healthyTimeout=3e4;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}}function Vs(){return new Hs("")}function $s(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function Xs(e){return e.pieces_.length-e.pieceNum_}function Ks(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new Hs(e.pieces_,t)}function Ys(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function Gs(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Qs(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new Hs(t,0)}function Js(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof Hs)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new Hs(n,0)}function Zs(e){return e.pieceNum_>=e.pieces_.length}function eo(e,t){const n=$s(e),i=$s(t);if(null===n)return t;if(n===i)return eo(Ks(e),Ks(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function to(e,t){if(Xs(e)!==Xs(t))return!1;for(let n=e.pieceNum_,i=t.pieceNum_;n<=e.pieces_.length;n++,i++)if(e.pieces_[n]!==t.pieces_[i])return!1;return!0}function no(e,t){let n=e.pieceNum_,i=t.pieceNum_;if(Xs(e)>Xs(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[i])return!1;++n,++i}return!0}class io{constructor(e,t){this.errorPrefix_=t,this.parts_=Gs(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=Q(this.parts_[e]);ro(this)}}function ro(e){if(e.byteLength_>768)throw new Error(e.errorPrefix_+"has a key path longer than 768 bytes ("+e.byteLength_+").");if(e.parts_.length>32)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written (32) or object contains a cycle "+so(e))}function so(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oo extends Bs{static getInstance(){return new oo}getInitialEvent(e){return d("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let uo;class ho extends co{static get __EMPTY_NODE(){return uo}static set __EMPTY_NODE(e){uo=e}compare(e,t){return ps(e.name,t.name)}isDefinedOn(e){throw p("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return lo.MIN}maxPost(){return new lo("[MAX_NAME]",uo)}makePost(e,t){return d("string"==typeof e,"KeyIndex indexValue must always be a string."),new lo(e,uo)}toString(){return".key"}}const po=new ho;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function yo(e,t){return ps(e.name,t.name)}function vo(e,t){return ps(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _o;go.EMPTY_NODE=new class{copy(e,t,n,i,r){return this}insert(e,t,n){return new mo(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const bo=function(e){return"number"==typeof e?"number:"+_s(e):"string:"+e},wo=function(e){if(e.isLeafNode()){const t=e.val();d("string"==typeof t||"number"==typeof t||"object"==typeof t&&D(t,".sv"),"Priority must be a string or number.")}else d(e===_o||e.isEmpty(),"priority of unexpected type.");d(e===_o||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let xo,ko,Co;class Io{static set __childrenNodeConstructor(e){xo=e}static get __childrenNodeConstructor(){return xo}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Io(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Io.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Zs(e)?this:".priority"===$s(e)?this.priorityNode_:Io.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Io.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=$s(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(d(".priority"!==n||1===Xs(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Io.__childrenNodeConstructor.EMPTY_NODE.updateChild(Ks(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+bo(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?_s(this.value_):this.value_,this.lazyHash_=ns(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Io.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Io.__childrenNodeConstructor?-1:(d(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,i=Io.VALUE_TYPE_ORDER.indexOf(t),r=Io.VALUE_TYPE_ORDER.indexOf(n);return d(i>=0,"Unknown leaf type: "+t),d(r>=0,"Unknown leaf type: "+n),i===r?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=Io.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,d(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),wo(this.priorityNode_)}}Io.VALUE_TYPE_ORDER=["object","boolean","number","string"];const No=new class extends co{compare(e,t){const n=e.node.getPriority(),i=t.node.getPriority(),r=n.compareTo(i);return 0===r?ps(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return lo.MIN}maxPost(){return new lo("[MAX_NAME]",new Io("[PRIORITY-POST]",Co))}makePost(e,t){const n=ko(e);return new lo(t,new Io("[PRIORITY-POST]",n))}toString(){return".priority"}},To=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/To,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}}const So=function(e,t,n,i){e.sort(t);const r=function(t,i){const s=i-t;let o,a;if(0===s)return null;if(1===s)return o=e[t],a=n?n(o):o,new mo(a,o.node,mo.BLACK,null,null);{const l=parseInt(s/2,10)+t,c=r(t,l),u=r(l+1,i);return o=e[l],a=n?n(o):o,new mo(a,o.node,mo.BLACK,c,u)}},s=function(t){let i=null,s=null,o=e.length;const a=function(t,i){const s=o-t,a=o;o-=t;const c=r(s+1,a),u=e[s],h=n?n(u):u;l(new mo(h,u.node,i,null,c))},l=function(e){i?(i.left=e,i=e):(s=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,mo.BLACK):(a(i,mo.BLACK),a(i,mo.RED))}return s}(new Eo(e.length));return new go(i||t,s)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ro;const Lo={};class Po{static get Default(){return d(Lo&&No,"ChildrenNode.ts has not been loaded"),Ro=Ro||new Po({".priority":Lo},{".priority":No}),Ro}get(e){const t=F(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof go?t:null}hasIndex(e){return D(this.indexSet_,e.toString())}addIndex(e,t){d(e!==po,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const r=t.getIterator(lo.Wrap);let s,o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=r.getNext();s=i?So(n,e.getCompare()):Lo;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=s,new Po(c,l)}addToIndexes(e,t){const n=W(this.indexes_,((n,i)=>{const r=F(this.indexSet_,i);if(d(r,"Missing index implementation for "+i),n===Lo){if(r.isDefinedOn(e.node)){const n=[],i=t.getIterator(lo.Wrap);let s=i.getNext();for(;s;)s.name!==e.name&&n.push(s),s=i.getNext();return n.push(e),So(n,r.getCompare())}return Lo}{const i=t.get(e.name);let r=n;return i&&(r=r.remove(new lo(e.name,i))),r.insert(e,e.node)}}));return new Po(n,this.indexSet_)}removeFromIndexes(e,t){const n=W(this.indexes_,(n=>{if(n===Lo)return n;{const i=t.get(e.name);return i?n.remove(new lo(e.name,i)):n}}));return new Po(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ao;class Mo{static get EMPTY_NODE(){return Ao||(Ao=new Mo(new go(vo),null,Po.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Ao}updatePriority(e){return this.children_.isEmpty()?this:new Mo(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?Ao:t}}getChild(e){const t=$s(e);return null===t?this:this.getImmediateChild(t).getChild(Ks(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(d(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new lo(e,t);let i,r;t.isEmpty()?(i=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(n,this.children_)):(i=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(n,this.children_));const s=i.isEmpty()?Ao:this.priorityNode_;return new Mo(i,s,r)}}updateChild(e,t){const n=$s(e);if(null===n)return t;{d(".priority"!==$s(e)||1===Xs(e),".priority must be the last token in a path");const i=this.getImmediateChild(n).updateChild(Ks(e),t);return this.updateImmediateChild(n,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,i=0,r=!0;if(this.forEachChild(No,((s,o)=>{t[s]=o.val(e),n++,r&&Mo.INTEGER_REGEXP_.test(s)?i=Math.max(i,Number(s)):r=!1})),!e&&r&&i<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+bo(this.getPriority().val())+":"),this.forEachChild(No,((t,n)=>{const i=n.hash();""!==i&&(e+=":"+t+":"+i)})),this.lazyHash_=""===e?"":ns(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const i=this.resolveIndex_(n);if(i){const n=i.getPredecessorKey(new lo(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new lo(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new lo(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,lo.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)<0;)n.getNext(),i=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,lo.Wrap);let i=n.peek();for(;null!=i&&t.compare(i,e)>0;)n.getNext(),i=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Oo?-1:0}withIndex(e){if(e===po||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Mo(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===po||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(No),n=t.getIterator(No);let i=e.getNext(),r=n.getNext();for(;i&&r;){if(i.name!==r.name||!i.node.equals(r.node))return!1;i=e.getNext(),r=n.getNext()}return null===i&&null===r}return!1}return!1}}resolveIndex_(e){return e===po?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&wo(this.priorityNode_),this.children_.isEmpty()&&d(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}Mo.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const Oo=new class extends Mo{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Mo.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new go(vo),Mo.EMPTY_NODE,Po.Default)}};Object.defineProperties(lo,{MIN:{value:new lo("[MIN_NAME]",Mo.EMPTY_NODE)},MAX:{value:new lo("[MAX_NAME]",Oo)}}),ho.__EMPTY_NODE=Mo.EMPTY_NODE,Io.__childrenNodeConstructor=Mo,_o=Oo,function(e){Co=e}(Oo);function Do(e,t=null){if(null===e)return Mo.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),d(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Io(e,Do(t))}if(e instanceof Array){let n=Mo.EMPTY_NODE;return vs(e,((t,i)=>{if(D(e,t)&&"."!==t.substring(0,1)){const e=Do(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Do(t))}{const n=[];let i=!1;if(vs(e,((e,t)=>{if("."!==e.substring(0,1)){const r=Do(t);r.isEmpty()||(i=i||!r.getPriority().isEmpty(),n.push(new lo(e,r)))}})),0===n.length)return Mo.EMPTY_NODE;const r=So(n,yo,(e=>e.name),vo);if(i){const e=So(n,No.getCompare());return new Mo(r,Do(t),new Po({".priority":e},{".priority":No}))}return new Mo(r,Do(t),Po.Default)}}!function(e){ko=e}(Do);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fo extends co{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?ps(e.name,t.name):r}makePost(e,t){const n=Do(e),i=Mo.EMPTY_NODE.updateChild(this.indexPath_,n);return new lo(t,i)}maxPost(){const e=Mo.EMPTY_NODE.updateChild(this.indexPath_,Oo);return new lo("[MAX_NAME]",e)}toString(){return Gs(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,d(!Zs(e)&&".priority"!==$s(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zo=new class extends co{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?ps(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return lo.MIN}maxPost(){return lo.MAX}makePost(e,t){const n=Do(e);return new lo(t,n)}toString(){return".value"}},Wo="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",Uo=function(){let e=0;const t=[];return function(n){const i=n===e;let r;e=n;const s=new Array(8);for(r=7;r>=0;r--)s[r]=Wo.charAt(n%64),n=Math.floor(n/64);d(0===n,"Cannot push at time == 0");let o=s.join("");if(i){for(r=11;r>=0&&63===t[r];r--)t[r]=0;t[r]++}else for(r=0;r<12;r++)t[r]=Math.floor(64*Math.random());for(r=0;r<12;r++)o+=Wo.charAt(t[r]);return d(20===o.length,"nextPushId: Length should be 20."),o}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function qo(e){return{type:"value",snapshotNode:e}}function Bo(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function jo(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Ho(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Vo{updateChild(e,t,n,i,r,s){d(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(i).equals(n.getChild(i))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(jo(t,o)):d(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(Bo(t,n)):s.trackChildChange(Ho(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(No,((e,i)=>{t.hasChild(e)||n.trackChildChange(jo(e,i))})),t.isLeafNode()||t.forEachChild(No,((t,i)=>{if(e.hasChild(t)){const r=e.getImmediateChild(t);r.equals(i)||n.trackChildChange(Ho(t,i,r))}else n.trackChildChange(Bo(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?Mo.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o{getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){return this.index_.compare(this.getStartPost(),e)<=0&&this.index_.compare(e,this.getEndPost())<=0}updateChild(e,t,n,i,r,s){return this.matches(new lo(t,n))||(n=Mo.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,i,r,s)}updateFullNode(e,t,n){t.isLeafNode()&&(t=Mo.EMPTY_NODE);let i=t.withIndex(this.index_);i=i.updatePriority(Mo.EMPTY_NODE);const r=this;return t.forEachChild(No,((e,t)=>{r.matches(new lo(e,t))||(i=i.updateImmediateChild(e,Mo.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,i,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}constructor(e){this.indexedFilter_=new Vo(e.getIndex()),this.index_=e.getIndex(),this.startPost_=$o.getStartPost_(e),this.endPost_=$o.getEndPost_(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{updateChild(e,t,n,i,r,s){return this.rangedFilter_.matches(new lo(t,n))||(n=Mo.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,i,r,s):this.fullLimitUpdateChild_(e,t,n,r,s)}updateFullNode(e,t,n){let i;if(t.isLeafNode()||t.isEmpty())i=Mo.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;i=Mo.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();let r;if(r=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),t)<=0:this.index_.compare(t,this.rangedFilter_.getEndPost())<=0,!r)break;i=i.updateImmediateChild(t.name,t.node),n++}}else{let e,n,r,s;if(i=t.withIndex(this.index_),i=i.updatePriority(Mo.EMPTY_NODE),this.reverse_){s=i.getReverseIterator(this.index_),e=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const t=this.index_.getCompare();r=(e,n)=>t(n,e)}else s=i.getIterator(this.index_),e=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),r=this.index_.getCompare();let o=0,a=!1;for(;s.hasNext();){const t=s.getNext();!a&&r(e,t)<=0&&(a=!0);a&&o<this.limit_&&r(t,n)<=0?o++:i=i.updateImmediateChild(t.name,Mo.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,i,r){let s;if(this.reverse_){const e=this.index_.getCompare();s=(t,n)=>e(n,t)}else s=this.index_.getCompare();const o=e;d(o.numChildren()===this.limit_,"");const a=new lo(t,n),l=this.reverse_?o.getFirstChild(this.index_):o.getLastChild(this.index_),c=this.rangedFilter_.matches(a);if(o.hasChild(t)){const e=o.getImmediateChild(t);let u=i.getChildAfterChild(this.index_,l,this.reverse_);for(;null!=u&&(u.name===t||o.hasChild(u.name));)u=i.getChildAfterChild(this.index_,u,this.reverse_);const h=null==u?1:s(u,a);if(c&&!n.isEmpty()&&h>=0)return null!=r&&r.trackChildChange(Ho(t,n,e)),o.updateImmediateChild(t,n);{null!=r&&r.trackChildChange(jo(t,e));const n=o.updateImmediateChild(t,Mo.EMPTY_NODE);return null!=u&&this.rangedFilter_.matches(u)?(null!=r&&r.trackChildChange(Bo(u.name,u.node)),n.updateImmediateChild(u.name,u.node)):n}}return n.isEmpty()?e:c&&s(l,a)>=0?(null!=r&&(r.trackChildChange(jo(l.name,l.node)),r.trackChildChange(Bo(t,n))),o.updateImmediateChild(t,n).updateImmediateChild(l.name,Mo.EMPTY_NODE)):e}constructor(e){this.rangedFilter_=new $o(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return d(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return d(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return d(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return d(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return d(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===No}copy(){const e=new Ko;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=No}}function Yo(e){const t={};if(e.isDefault())return t;let n;return e.index_===No?n="$priority":e.index_===zo?n="$value":e.index_===po?n="$key":(d(e.index_ instanceof Fo,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=P(n),e.startSet_&&(t.startAt=P(e.indexStartValue_),e.startNameSet_&&(t.startAt+=","+P(e.indexStartName_))),e.endSet_&&(t.endAt=P(e.indexEndValue_),e.endNameSet_&&(t.endAt+=","+P(e.indexEndName_))),e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function Go(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_)),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_)),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==No&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo extends qs{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(d(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const s=Qo.getListenId_(e,n),o={};this.listens_[s]=o;const a=Yo(e._queryParams);this.restRequest_(r+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(r,a,!1,n),F(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Qo.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Yo(e._queryParams),n=e._path.toString(),i=new w;return this.restRequest_(n+".json",t,((e,t)=>{let r=t;404===e&&(r=null,e=null),null===e?(this.onDataUpdate_(n,r,!1,null),i.resolve(r)):i.reject(new Error(r))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+B(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=L(o.responseText)}catch(e){hs("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&hs("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=ls("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=Mo.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zo(){return{value:null,children:new Map}}function ea(e,t,n){if(Zs(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=$s(t);e.children.has(i)||e.children.set(i,Zo());ea(e.children.get(i),t=Ks(t),n)}}function ta(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{ta(i,new Hs(t.toString()+"/"+e),n)}))}class na{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&vs(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;vs(e,((e,i)=>{i>0&&D(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),ks(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new na(e);const n=1e4+2e4*Math.random();ks(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ra,sa;function oa(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(sa=ra||(ra={}))[sa.OVERWRITE=0]="OVERWRITE",sa[sa.MERGE=1]="MERGE",sa[sa.ACK_USER_WRITE=2]="ACK_USER_WRITE",sa[sa.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class aa{operationForChild(e){if(Zs(this.path)){if(null!=this.affectedTree.value)return d(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Hs(e));return new aa(Vs(),t,this.revert)}}return d($s(this.path)===e,"operationForChild called for unrelated child."),new aa(Ks(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=ra.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class la{operationForChild(e){return Zs(this.path)?new la(this.source,Vs()):new la(this.source,Ks(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=ra.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ca{operationForChild(e){return Zs(this.path)?new ca(this.source,Vs(),this.snap.getImmediateChild(e)):new ca(this.source,Ks(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=ra.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ua{operationForChild(e){if(Zs(this.path)){const t=this.children.subtree(new Hs(e));return t.isEmpty()?null:t.value?new ca(this.source,Vs(),t.value):new ua(this.source,Vs(),t)}return d($s(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ua(this.source,Ks(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=ra.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class da{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function pa(e,t,n,i,r,s){const o=i.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw p("Should only compare child_ events.");const i=new lo(t.childName,t.snapshotNode),r=new lo(n.childName,n.snapshotNode);return e.index_.compare(i,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);r.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function fa(e,t){return{eventCache:e,serverCache:t}}function ma(e,t,n,i){return fa(new ha(t,n,i),e.serverCache)}function ga(e,t,n,i){return fa(e.eventCache,new ha(t,n,i))}function ya(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function va(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _a;class ba{static fromObject(e){let t=new ba(null);return vs(e,((e,n)=>{t=t.set(new Hs(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Vs(),value:this.value};if(Zs(e))return null;{const n=$s(e),i=this.children.get(n);if(null!==i){const r=i.findRootMostMatchingPathAndValue(Ks(e),t);if(null!=r){return{path:Js(new Hs(n),r.path),value:r.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Zs(e))return this;{const t=$s(e),n=this.children.get(t);return null!==n?n.subtree(Ks(e)):new ba(null)}}set(e,t){if(Zs(e))return new ba(t,this.children);{const n=$s(e),i=(this.children.get(n)||new ba(null)).set(Ks(e),t),r=this.children.insert(n,i);return new ba(this.value,r)}}remove(e){if(Zs(e))return this.children.isEmpty()?new ba(null):new ba(null,this.children);{const t=$s(e),n=this.children.get(t);if(n){const i=n.remove(Ks(e));let r;return r=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&r.isEmpty()?new ba(null):new ba(this.value,r)}return this}}get(e){if(Zs(e))return this.value;{const t=$s(e),n=this.children.get(t);return n?n.get(Ks(e)):null}}setTree(e,t){if(Zs(e))return t;{const n=$s(e),i=(this.children.get(n)||new ba(null)).setTree(Ks(e),t);let r;return r=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new ba(this.value,r)}}fold(e){return this.fold_(Vs(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,r)=>{n[i]=r.fold_(Js(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Vs(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Zs(e))return null;{const i=$s(e),r=this.children.get(i);return r?r.findOnPath_(Ks(e),Js(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Vs(),t)}foreachOnPath_(e,t,n){if(Zs(e))return this;{this.value&&n(t,this.value);const i=$s(e),r=this.children.get(i);return r?r.foreachOnPath_(Ks(e),Js(t,i),n):new ba(null)}}foreach(e){this.foreach_(Vs(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Js(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(_a||(_a=new go(fs)),_a))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wa{static empty(){return new wa(new ba(null))}constructor(e){this.writeTree_=e}}function xa(e,t,n){if(Zs(t))return new wa(new ba(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=eo(r,t);return s=s.updateChild(o,n),new wa(e.writeTree_.set(r,s))}{const i=new ba(n),r=e.writeTree_.setTree(t,i);return new wa(r)}}}function ka(e,t,n){let i=e;return vs(n,((e,n)=>{i=xa(i,Js(t,e),n)})),i}function Ca(e,t){if(Zs(t))return wa.empty();{const n=e.writeTree_.setTree(t,new ba(null));return new wa(n)}}function Ia(e,t){return null!=Na(e,t)}function Na(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(eo(n.path,t)):null}function Ta(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(No,((e,n)=>{t.push(new lo(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new lo(e,n.value))})),t}function Ea(e,t){if(Zs(t))return e;{const n=Na(e,t);return new wa(null!=n?new ba(n):e.writeTree_.subtree(t))}}function Sa(e){return e.writeTree_.isEmpty()}function Ra(e,t){return La(Vs(),e.writeTree_,t)}function La(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?(d(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=La(Js(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(Js(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pa(e,t){return Va(t,e)}function Aa(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));d(n>=0,"removeWrite called with nonexistent writeId.");const i=e.allWrites[n];e.allWrites.splice(n,1);let r=i.visible,s=!1,o=e.allWrites.length-1;for(;r&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&Ma(t,i.path)?r=!1:no(i.path,t.path)&&(s=!0)),o--}if(r){if(s)return function(e){e.visibleWrites=Da(e.allWrites,Oa,Vs()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(i.snap)e.visibleWrites=Ca(e.visibleWrites,i.path);else{vs(i.children,(t=>{e.visibleWrites=Ca(e.visibleWrites,Js(i.path,t))}))}return!0}return!1}function Ma(e,t){if(e.snap)return no(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&no(Js(e.path,n),t))return!0;return!1}function Oa(e){return e.visible}function Da(e,t,n){let i=wa.empty();for(let r=0;r<e.length;++r){const s=e[r];if(t(s)){const e=s.path;let t;if(s.snap)no(n,e)?(t=eo(n,e),i=xa(i,t,s.snap)):no(e,n)&&(t=eo(e,n),i=xa(i,Vs(),s.snap.getChild(t)));else{if(!s.children)throw p("WriteRecord should have .snap or .children");if(no(n,e))t=eo(n,e),i=ka(i,t,s.children);else if(no(e,n))if(t=eo(e,n),Zs(t))i=ka(i,Vs(),s.children);else{const e=F(s.children,$s(t));if(e){const n=e.getChild(Ks(t));i=xa(i,Vs(),n)}}}}}return i}function Fa(e,t,n,i,r){if(i||r){const s=Ea(e.visibleWrites,t);if(!r&&Sa(s))return n;if(r||null!=n||Ia(s,Vs())){const s=function(e){return(e.visible||r)&&(!i||!~i.indexOf(e.writeId))&&(no(e.path,t)||no(t,e.path))};return Ra(Da(e.allWrites,s,t),n||Mo.EMPTY_NODE)}return null}{const i=Na(e.visibleWrites,t);if(null!=i)return i;{const i=Ea(e.visibleWrites,t);if(Sa(i))return n;if(null!=n||Ia(i,Vs())){return Ra(i,n||Mo.EMPTY_NODE)}return null}}}function za(e,t,n,i){return Fa(e.writeTree,e.treePath,t,n,i)}function Wa(e,t){return function(e,t,n){let i=Mo.EMPTY_NODE;const r=Na(e.visibleWrites,t);if(r)return r.isLeafNode()||r.forEachChild(No,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const r=Ea(e.visibleWrites,t);return n.forEachChild(No,((e,t)=>{const n=Ra(Ea(r,new Hs(e)),t);i=i.updateImmediateChild(e,n)})),Ta(r).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}return Ta(Ea(e.visibleWrites,t)).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function Ua(e,t,n,i){return function(e,t,n,i,r){d(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=Js(t,n);if(Ia(e.visibleWrites,s))return null;{const t=Ea(e.visibleWrites,s);return Sa(t)?r.getChild(n):Ra(t,r.getChild(n))}}(e.writeTree,e.treePath,t,n,i)}function qa(e,t){return function(e,t){return Na(e.visibleWrites,t)}(e.writeTree,Js(e.treePath,t))}function Ba(e,t,n,i,r,s){return function(e,t,n,i,r,s,o){let a;const l=Ea(e.visibleWrites,t),c=Na(l,Vs());if(null!=c)a=c;else{if(null==n)return[];a=Ra(l,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let l=n.getNext();for(;l&&e.length<r;)0!==t(l,i)&&e.push(l),l=n.getNext();return e}}(e.writeTree,e.treePath,t,n,i,r,s)}function ja(e,t,n){return function(e,t,n,i){const r=Js(t,n),s=Na(e.visibleWrites,r);if(null!=s)return s;if(i.isCompleteForChild(n))return Ra(Ea(e.visibleWrites,r),i.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Ha(e,t){return Va(Js(e.treePath,t),e.writeTree)}function Va(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $a{trackChildChange(e){const t=e.type,n=e.childName;d("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),d(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,Ho(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,jo(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,Bo(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw p("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Ho(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Ka{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new ha(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ja(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:va(this.viewCache_),r=Ba(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ya(e,t,n,i,r){const s=new $a;let o,a;if(n.type===ra.OVERWRITE){const l=n;l.source.fromUser?o=Ja(e,t,l.path,l.snap,i,r,s):(d(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Zs(l.path),o=Qa(e,t,l.path,l.snap,i,r,a,s))}else if(n.type===ra.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,l)=>{const c=Js(n,i);Za(t,$s(c))&&(a=Ja(e,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=Js(n,i);Za(t,$s(c))||(a=Ja(e,a,c,l,r,s,o))})),a}(e,t,l.path,l.children,i,r,s):(d(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=tl(e,t,l.path,l.children,i,r,a,s))}else if(n.type===ra.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=qa(i,n))return t;{const a=new Ka(i,t,r),l=t.eventCache.getNode();let c;if(Zs(n)||".priority"===$s(n)){let n;if(t.serverCache.isFullyInitialized())n=za(i,va(t));else{const e=t.serverCache.getNode();d(e instanceof Mo,"serverChildren would be complete if leaf node"),n=Wa(i,e)}c=e.filter.updateFullNode(l,n,s)}else{const r=$s(n);let u=ja(i,r,t.serverCache);null==u&&t.serverCache.isCompleteForChild(r)&&(u=l.getImmediateChild(r)),c=null!=u?e.filter.updateChild(l,r,u,Ks(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(l,r,Mo.EMPTY_NODE,Ks(n),a,s):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=za(i,va(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=qa(i,Vs()),ma(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,i,r,s):function(e,t,n,i,r,s,o){if(null!=qa(r,n))return t;const a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=i.value){if(Zs(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Qa(e,t,n,l.getNode().getChild(n),r,s,a,o);if(Zs(n)){let i=new ba(null);return l.getNode().forEachChild(po,((e,t)=>{i=i.set(new Hs(e),t)})),tl(e,t,n,i,r,s,a,o)}return t}{let c=new ba(null);return i.foreach(((e,t)=>{const i=Js(n,e);l.isCompleteForPath(i)&&(c=c.set(e,l.getNode().getChild(i)))})),tl(e,t,n,c,r,s,a,o)}}(e,t,a.path,a.affectedTree,i,r,s)}else{if(n.type!==ra.LISTEN_COMPLETE)throw p("Unknown operation type: "+n.type);o=function(e,t,n,i,r){const s=t.serverCache,o=ga(t,s.getNode(),s.isFullyInitialized()||Zs(n),s.isFiltered());return Ga(e,o,n,i,Xa,r)}(e,t,n.path,i,s)}const l=s.getChanges();return function(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=ya(e);(n.length>0||!e.eventCache.isFullyInitialized()||r&&!i.getNode().equals(s)||!i.getNode().getPriority().equals(s.getPriority()))&&n.push(qo(ya(t)))}}(t,o,l),{viewCache:o,changes:l}}function Ga(e,t,n,i,r,s){const o=t.eventCache;if(null!=qa(i,n))return t;{let a,l;if(Zs(n))if(d(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=va(t),r=Wa(i,n instanceof Mo?n:Mo.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),r,s)}else{const n=za(i,va(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const c=$s(n);if(".priority"===c){d(1===Xs(n),"Can't have a priority with additional path components");const r=o.getNode();l=t.serverCache.getNode();const s=Ua(i,n,r,l);a=null!=s?e.filter.updatePriority(r,s):o.getNode()}else{const u=Ks(n);let h;if(o.isCompleteForChild(c)){l=t.serverCache.getNode();const e=Ua(i,n,o.getNode(),l);h=null!=e?o.getNode().getImmediateChild(c).updateChild(u,e):o.getNode().getImmediateChild(c)}else h=ja(i,c,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),c,h,u,r,s):o.getNode()}}return ma(t,a,o.isFullyInitialized()||Zs(n),e.filter.filtersNodes())}}function Qa(e,t,n,i,r,s,o,a){const l=t.serverCache;let c;const u=o?e.filter:e.filter.getIndexedFilter();if(Zs(n))c=u.updateFullNode(l.getNode(),i,null);else if(u.filtersNodes()&&!l.isFiltered()){const e=l.getNode().updateChild(n,i);c=u.updateFullNode(l.getNode(),e,null)}else{const e=$s(n);if(!l.isCompleteForPath(n)&&Xs(n)>1)return t;const r=Ks(n),s=l.getNode().getImmediateChild(e).updateChild(r,i);c=".priority"===e?u.updatePriority(l.getNode(),s):u.updateChild(l.getNode(),e,s,r,Xa,null)}const h=ga(t,c,l.isFullyInitialized()||Zs(n),u.filtersNodes());return Ga(e,h,n,r,new Ka(r,h,s),a)}function Ja(e,t,n,i,r,s,o){const a=t.eventCache;let l,c;const u=new Ka(r,t,s);if(Zs(n))c=e.filter.updateFullNode(t.eventCache.getNode(),i,o),l=ma(t,c,!0,e.filter.filtersNodes());else{const r=$s(n);if(".priority"===r)c=e.filter.updatePriority(t.eventCache.getNode(),i),l=ma(t,c,a.isFullyInitialized(),a.isFiltered());else{const s=Ks(n),c=a.getNode().getImmediateChild(r);let h;if(Zs(s))h=i;else{const e=u.getCompleteChild(r);h=null!=e?".priority"===Ys(s)&&e.getChild(Qs(s)).isEmpty()?e:e.updateChild(s,i):Mo.EMPTY_NODE}if(c.equals(h))l=t;else{l=ma(t,e.filter.updateChild(a.getNode(),r,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return l}function Za(e,t){return e.eventCache.isCompleteForChild(t)}function el(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function tl(e,t,n,i,r,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let l,c=t;l=Zs(n)?i:new ba(null).setTree(n,i);const u=t.serverCache.getNode();return l.children.inorderTraversal(((n,i)=>{if(u.hasChild(n)){const l=el(0,t.serverCache.getNode().getImmediateChild(n),i);c=Qa(e,c,new Hs(n),l,r,s,o,a)}})),l.children.inorderTraversal(((n,i)=>{const l=!t.serverCache.isCompleteForChild(n)&&null===i.value;if(!u.hasChild(n)&&!l){const l=el(0,t.serverCache.getNode().getImmediateChild(n),i);c=Qa(e,c,new Hs(n),l,r,s,o,a)}})),c}class nl{get query(){return this.query_}constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new Vo(n.getIndex()),r=(s=n).loadsAllData()?new Vo(s.getIndex()):s.hasLimit()?new Xo(s):new $o(s);var s;this.processor_=function(e){return{filter:e}}(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(Mo.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(Mo.EMPTY_NODE,a.getNode(),null),u=new ha(l,o.isFullyInitialized(),i.filtersNodes()),h=new ha(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=fa(h,u),this.eventGenerator_=new da(this.query_)}}function il(e,t){const n=va(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Zs(t)&&!n.getImmediateChild($s(t)).isEmpty())?n.getChild(t):null}function rl(e){return 0===e.eventRegistrations_.length}function sl(e,t,n){const i=[];if(n){d(null==t,"A cancel should cancel all event registrations.");const r=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,r);t&&i.push(t)}))}if(t){let n=[];for(let i=0;i<e.eventRegistrations_.length;++i){const r=e.eventRegistrations_[i];if(r.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(i+1));break}}else n.push(r)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return i}function ol(e,t,n,i){t.type===ra.MERGE&&null!==t.source.queryId&&(d(va(e.viewCache_),"We should always have a full cache before handling merges"),d(ya(e.viewCache_),"Missing event cache, even though we have a server cache"));const r=e.viewCache_,s=Ya(e.processor_,r,t,n,i);var o,a;return o=e.processor_,a=s.viewCache,d(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),d(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),d(s.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,al(e,s.changes,s.viewCache.eventCache.getNode(),null)}function al(e,t,n,i){const r=i?[i]:e.eventRegistrations_;return function(e,t,n,i){const r=[],s=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),pa(e,r,"child_removed",t,i,n),pa(e,r,"child_added",t,i,n),pa(e,r,"child_moved",s,i,n),pa(e,r,"child_changed",t,i,n),pa(e,r,"value",t,i,n),r}(e.eventGenerator_,t,n,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ll,cl;class ul{constructor(){this.views=new Map}}function hl(e,t,n,i){const r=t.source.queryId;if(null!==r){const s=e.views.get(r);return d(null!=s,"SyncTree gave us an op for an invalid query."),ol(s,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(ol(s,t,n,i));return r}}function dl(e,t,n,i,r){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=za(n,r?i:null),s=!1;e?s=!0:i instanceof Mo?(e=Wa(n,i),s=!1):(e=Mo.EMPTY_NODE,s=!1);const o=fa(new ha(e,s,!1),new ha(i,r,!1));return new nl(t,o)}return o}function pl(e,t,n,i,r,s){const o=dl(e,t,i,r,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(No,((e,t)=>{i.push(Bo(e,t))}));return n.isFullyInitialized()&&i.push(qo(n.getNode())),al(e,i,n.getNode(),t)}(o,n)}function fl(e,t,n,i){const r=t._queryIdentifier,s=[];let o=[];const a=_l(e);if("default"===r)for(const[t,r]of e.views.entries())o=o.concat(sl(r,n,i)),rl(r)&&(e.views.delete(t),r.query._queryParams.loadsAllData()||s.push(r.query));else{const t=e.views.get(r);t&&(o=o.concat(sl(t,n,i)),rl(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!_l(e)&&s.push(new(d(ll,"Reference.ts has not been loaded"),ll)(t._repo,t._path)),{removed:s,events:o}}function ml(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function gl(e,t){let n=null;for(const i of e.views.values())n=n||il(i,t);return n}function yl(e,t){if(t._queryParams.loadsAllData())return bl(e);{const n=t._queryIdentifier;return e.views.get(n)}}function vl(e,t){return null!=yl(e,t)}function _l(e){return null!=bl(e)}function bl(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wl=1;class xl{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ba(null),this.pendingWriteTree_={visibleWrites:wa.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function kl(e,t,n,i,r){return function(e,t,n,i,r){d(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=xa(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Ll(e,new ca({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Cl(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Aa(e.pendingWriteTree_,t)){let t=new ba(null);return null!=i.snap?t=t.set(Vs(),!0):vs(i.children,(e=>{t=t.set(new Hs(e),!0)})),Ll(e,new aa(i.path,t,n))}return[]}function Il(e,t,n){return Ll(e,new ca({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Nl(e,t,n,i,r=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||vl(o,t))){const l=fl(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(s,((e,t)=>_l(t)));if(n&&!r){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&_l(t)){return[bl(t)]}{let e=[];return t&&(e=ml(t)),vs(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=Ml(e,i);e.listenProvider_.startListening(Ul(r),Ol(e,r),s.hashFn,s.onComplete)}}}if(!r&&c.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(Ul(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(Dl(t));e.listenProvider_.stopListening(Ul(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=Dl(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function Tl(e,t,n,i){const r=Fl(e,i);if(null!=r){const i=zl(r),s=i.path,o=i.queryId,a=eo(s,t);return Wl(e,s,new ca(oa(o),a,n))}return[]}function El(e,t,n,i=!1){const r=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=eo(e,r);s=s||gl(t,n),o=o||_l(t)}));let a,l=e.syncPointTree_.get(r);if(l?(o=o||_l(l),s=s||gl(l,Vs())):(l=new ul,e.syncPointTree_=e.syncPointTree_.set(r,l)),null!=s)a=!0;else{a=!1,s=Mo.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=gl(t,Vs());n&&(s=s.updateImmediateChild(e,n))}))}const c=vl(l,t);if(!c&&!t._queryParams.loadsAllData()){const n=Dl(t);d(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=wl++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let u=pl(l,t,n,Pa(e.pendingWriteTree_,r),s,a);if(!c&&!o&&!i){const n=yl(l,t);u=u.concat(function(e,t,n){const i=t._path,r=Ol(e,t),s=Ml(e,n),o=e.listenProvider_.startListening(Ul(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)d(!_l(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Zs(e)&&t&&_l(t))return[bl(t).query];{let e=[];return t&&(e=e.concat(ml(t).map((e=>e.query)))),vs(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(Ul(i),Ol(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return u}function Sl(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=gl(n,eo(e,t));if(i)return i}));return Fa(i,t,r,n,!0)}function Rl(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const r=eo(e,n);i=i||gl(t,r)}));let r=e.syncPointTree_.get(n);r?i=i||gl(r,Vs()):(r=new ul,e.syncPointTree_=e.syncPointTree_.set(n,r));const s=null!=i,o=s?new ha(i,!0,!1):null;return function(e){return ya(e.viewCache_)}(dl(r,t,Pa(e.pendingWriteTree_,t._path),s?o.getNode():Mo.EMPTY_NODE,s))}function Ll(e,t){return Pl(t,e.syncPointTree_,null,Pa(e.pendingWriteTree_,Vs()))}function Pl(e,t,n,i){if(Zs(e.path))return Al(e,t,n,i);{const r=t.get(Vs());null==n&&null!=r&&(n=gl(r,Vs()));let s=[];const o=$s(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Ha(i,o);s=s.concat(Pl(a,l,e,t))}return r&&(s=s.concat(hl(r,e,i,n))),s}}function Al(e,t,n,i){const r=t.get(Vs());null==n&&null!=r&&(n=gl(r,Vs()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=Ha(i,t),l=e.operationForChild(t);l&&(s=s.concat(Al(l,r,o,a)))})),r&&(s=s.concat(hl(r,e,i,n))),s}function Ml(e,t){const n=t.query,i=Ol(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||Mo.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=Fl(e,n);if(i){const n=zl(i),r=n.path,s=n.queryId,o=eo(r,t);return Wl(e,r,new la(oa(s),o))}return[]}(e,n._path,i):function(e,t){return Ll(e,new la({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return Nl(e,n,null,i)}}}}function Ol(e,t){const n=Dl(t);return e.queryToTagMap.get(n)}function Dl(e){return e._path.toString()+"$"+e._queryIdentifier}function Fl(e,t){return e.tagToQueryMap.get(t)}function zl(e){const t=e.indexOf("$");return d(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Hs(e.substr(0,t))}}function Wl(e,t,n){const i=e.syncPointTree_.get(t);d(i,"Missing sync point for query tag that we're tracking");return hl(i,n,Pa(e.pendingWriteTree_,t),null)}function Ul(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(d(cl,"Reference.ts has not been loaded"),cl)(e._repo,e._path):e}class ql{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ql(t)}node(){return this.node_}constructor(e){this.node_=e}}class Bl{getImmediateChild(e){const t=Js(this.path_,e);return new Bl(this.syncTree_,t)}node(){return Sl(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const jl=function(e,t,n){return e&&"object"==typeof e?(d(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Hl(e[".sv"],t,n):"object"==typeof e[".sv"]?Vl(e[".sv"],t):void d(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Hl=function(e,t,n){if("timestamp"===e)return n.timestamp;d(!1,"Unexpected server value: "+e)},Vl=function(e,t,n){e.hasOwnProperty("increment")||d(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&d(!1,"Unexpected increment value: "+i);const r=t.node();if(d(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const s=r.getValue();return"number"!=typeof s?i:s+i},$l=function(e,t,n,i){return Kl(t,new Bl(n,e),i)},Xl=function(e,t,n){return Kl(e,new ql(t),n)};function Kl(e,t,n){const i=e.getPriority().val(),r=jl(i,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const i=e,s=jl(i.getValue(),t,n);return s!==i.getValue()||r!==i.getPriority().val()?new Io(s,Do(r)):e}{const i=e;return s=i,r!==i.getPriority().val()&&(s=s.updatePriority(new Io(r))),i.forEachChild(No,((e,i)=>{const r=Kl(i,t.getImmediateChild(e),n);r!==i&&(s=s.updateImmediateChild(e,r))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yl{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Gl(e,t){let n=t instanceof Hs?t:new Hs(t),i=e,r=$s(n);for(;null!==r;){const e=F(i.node.children,r)||{children:{},childCount:0};i=new Yl(r,i,e),n=Ks(n),r=$s(n)}return i}function Ql(e){return e.node.value}function Jl(e,t){e.node.value=t,ic(e)}function Zl(e){return e.node.childCount>0}function ec(e,t){vs(e.node.children,((n,i)=>{t(new Yl(n,e,i))}))}function tc(e,t,n,i){n&&!i&&t(e),ec(e,(e=>{tc(e,t,!0,i)})),n&&i&&t(e)}function nc(e){return new Hs(null===e.parent?e.name:nc(e.parent)+"/"+e.name)}function ic(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===Ql(e)&&!Zl(e)}(n),r=D(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,ic(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,ic(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const rc=/[\[\].#$\/\u0000-\u001F\u007F]/,sc=/[\[\].#$\u0000-\u001F\u007F]/,oc=function(e){return"string"==typeof e&&0!==e.length&&!rc.test(e)},ac=function(e){return"string"==typeof e&&0!==e.length&&!sc.test(e)},lc=function(e,t,n,i){i&&void 0===t||cc(Y(e,"value"),t,n)},cc=function(e,t,n){const i=n instanceof Hs?new io(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+so(i));if("function"==typeof t)throw new Error(e+"contains a function "+so(i)+" with contents = "+t.toString());if(ds(t))throw new Error(e+"contains "+t.toString()+" "+so(i));if("string"==typeof t&&t.length>10485760/3&&Q(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+so(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(vs(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!oc(t)))throw new Error(e+" contains an invalid key ("+t+") "+so(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=i).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=Q(a),ro(o),cc(e,s,i),function(e){const t=e.parts_.pop();e.byteLength_-=Q(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&r)throw new Error(e+' contains ".value" child '+so(i)+" in addition to actual children.")}},uc=function(e,t,n,i){if(!(i&&void 0===n||ac(n)))throw new Error(Y(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},hc=function(e,t){if(".info"===$s(t))throw new Error(e+" failed = Can't modify data under /.info/")},dc=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!oc(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),ac(e)}(n))throw new Error(Y(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class pc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function fc(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||to(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function mc(e,t,n){fc(e,n),yc(e,(e=>to(e,t)))}function gc(e,t,n){fc(e,n),yc(e,(e=>no(e,t)||no(t,e)))}function yc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(vc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function vc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();rs&&as("event: "+n.toString()),xs(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _c{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new pc,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Zo(),this.transactionQueueTree_=new Yl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function bc(e,t,n){if(e.stats_=As(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Qo(e.repoInfo_,((t,n,i,r)=>{kc(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Cc(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{P(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new ao(e.repoInfo_,t,((t,n,i,r)=>{kc(e,t,n,i,r)}),(t=>{Cc(e,t)}),(t=>{!function(e,t){vs(t,((t,n)=>{Ic(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return Ps[n]||(Ps[n]=t()),Ps[n]}(e.repoInfo_,(()=>new ia(e.stats_,e.server_))),e.infoData_=new Jo,e.infoSyncTree_=new xl({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Il(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),Ic(e,"connected",!1),e.serverSyncTree_=new xl({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);gc(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function wc(e){const t=e.infoData_.getNode(new Hs(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function xc(e){return(t=(t={timestamp:wc(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function kc(e,t,n,i,r){e.dataUpdateCount++;const s=new Hs(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=W(n,(e=>Do(e)));o=function(e,t,n,i){const r=Fl(e,i);if(r){const i=zl(r),s=i.path,o=i.queryId,a=eo(s,t),l=ba.fromObject(n);return Wl(e,s,new ua(oa(o),a,l))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=Do(n);o=Tl(e.serverSyncTree_,s,t,r)}else if(i){const t=W(n,(e=>Do(e)));o=function(e,t,n){const i=ba.fromObject(n);return Ll(e,new ua({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=Do(n);o=Il(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=Mc(e,s)),gc(e.eventQueue_,a,o)}function Cc(e,t){Ic(e,"connected",t),!1===t&&function(e){Rc(e,"onDisconnectEvents");const t=xc(e),n=Zo();ta(e.onDisconnect_,Vs(),((i,r)=>{const s=$l(i,r,e.serverSyncTree_,t);ea(n,i,s)}));let i=[];ta(n,Vs(),((t,n)=>{i=i.concat(Il(e.serverSyncTree_,t,n));const r=Wc(e,t);Mc(e,r)})),e.onDisconnect_=Zo(),gc(e.eventQueue_,Vs(),i)}(e)}function Ic(e,t,n){const i=new Hs("/.info/"+t),r=Do(n);e.infoData_.updateSnapshot(i,r);const s=Il(e.infoSyncTree_,i,r);gc(e.eventQueue_,i,s)}function Nc(e){return e.nextWriteId_++}function Tc(e,t,n,i,r){Rc(e,"set",{path:t.toString(),value:n,priority:i});const s=xc(e),o=Do(n,i),a=Sl(e.serverSyncTree_,t),l=Xl(o,a,s),c=Nc(e),u=kl(e.serverSyncTree_,t,l,c,!0);fc(e.eventQueue_,u),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const s="ok"===n;s||hs("set at "+t+" failed: "+n);const o=Cl(e.serverSyncTree_,c,!s);gc(e.eventQueue_,t,o),Lc(e,r,n,i)}));const h=Wc(e,t);Mc(e,h),gc(e.eventQueue_,h,[])}function Ec(e,t,n){let i;i=".info"===$s(t._path)?Nl(e.infoSyncTree_,t,n):Nl(e.serverSyncTree_,t,n),mc(e.eventQueue_,t._path,i)}function Sc(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Rc(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),as(n,...t)}function Lc(e,t,n,i){t&&xs((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let r=e;i&&(r+=": "+i);const s=new Error(r);s.code=e,t(s)}}))}function Pc(e,t,n){return Sl(e.serverSyncTree_,t,n)||Mo.EMPTY_NODE}function Ac(e,t=e.transactionQueueTree_){if(t||zc(e,t),Ql(t)){const n=Dc(e,t);d(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=Pc(e,t,i);let s=r;const o=r.hash();for(let e=0;e<n.length;e++){const i=n[e];d(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=eo(t,i.path);s=s.updateChild(r,i.currentOutputSnapshotRaw)}const a=s.val(!0),l=t;e.server_.put(l.toString(),a,(i=>{Rc(e,"transaction put response",{path:l.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(Cl(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();zc(e,Gl(e.transactionQueueTree_,t)),Ac(e,e.transactionQueueTree_),gc(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)xs(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{hs("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}Mc(e,t)}}),o)}(e,nc(t),n)}else Zl(t)&&ec(t,(t=>{Ac(e,t)}))}function Mc(e,t){const n=Oc(e,t),i=nc(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=eo(n,l.path);let u,h=!1;if(d(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)h=!0,u=l.abortReason,r=r.concat(Cl(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)h=!0,u="maxretry",r=r.concat(Cl(e.serverSyncTree_,l.currentWriteId,!0));else{const n=Pc(e,l.path,s);l.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){cc("transaction failed: Data returned ",i,l.path);let t=Do(i);"object"==typeof i&&null!=i&&D(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=l.currentWriteId,a=xc(e),c=Xl(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=Nc(e),s.splice(s.indexOf(o),1),r=r.concat(kl(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),r=r.concat(Cl(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",r=r.concat(Cl(e.serverSyncTree_,l.currentWriteId,!0))}gc(e.eventQueue_,n,r),r=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;zc(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)xs(i[e]);Ac(e,e.transactionQueueTree_)}(e,Dc(e,n),i),i}function Oc(e,t){let n,i=e.transactionQueueTree_;for(n=$s(t);null!==n&&void 0===Ql(i);)i=Gl(i,n),n=$s(t=Ks(t));return i}function Dc(e,t){const n=[];return Fc(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function Fc(e,t,n){const i=Ql(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);ec(t,(t=>{Fc(e,t,n)}))}function zc(e,t){const n=Ql(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Jl(t,n.length>0?n:void 0)}ec(t,(t=>{zc(e,t)}))}function Wc(e,t){const n=nc(Oc(e,t)),i=Gl(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{Uc(e,t)})),Uc(e,i),tc(i,(t=>{Uc(e,t)})),n}function Uc(e,t){const n=Ql(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(d(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(d(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(Cl(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Jl(t,void 0):n.length=s+1,gc(e.eventQueue_,nc(t),r);for(let e=0;e<i.length;e++)xs(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vc{onValue(e,t){this.snapshotCallback.call(null,e,t)}onCancel(e){return d(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}get hasCancelCallback(){return!!this.cancelCallback}matches(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}constructor(e,t){this.snapshotCallback=e,this.cancelCallback=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class $c{get key(){return Zs(this._path)?null:Ys(this._path)}get ref(){return new Xc(this._repo,this._path)}get _queryIdentifier(){const e=Go(this._queryParams),t=gs(e);return"{}"===t?"default":t}get _queryObject(){return Go(this._queryParams)}isEqual(e){if(!((e=J(e))instanceof $c))return!1;const t=this._repo===e._repo,n=to(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class Xc extends $c{get parent(){const e=Qs(this._path);return null===e?null:new Xc(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new Ko,!1)}}class Kc{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Hs(e),n=Gc(this.ref,e);return new Kc(this._node.getChild(t),n,No)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Kc(n,Gc(this.ref,t),No))))}hasChild(e){const t=new Hs(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Yc(e,t){return(e=J(e))._checkNotDeleted("ref"),void 0!==t?Gc(e._root,t):e._root}function Gc(e,t){var n,i,r,s;return null===$s((e=J(e))._path)?(n="child",i="path",s=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),uc(n,i,r,s)):uc("child","path",t,!1),new Xc(e._repo,Js(e._path,t))}function Qc(e,t){e=J(e),hc("push",e._path),lc("push",t,e._path,!0);const n=wc(e._repo),i=Uo(n),r=Gc(e,i),s=Gc(e,i);let o;return o=null!=t?Jc(s,t).then((()=>s)):Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function Jc(e,t){e=J(e),hc("set",e._path),lc("set",t,e._path,!1);const n=new w;return Tc(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Zc(e){e=J(e);const t=new Vc((()=>{})),n=new eu(t);return function(e,t,n){const i=Rl(e.serverSyncTree_,t);return null!=i?Promise.resolve(i):e.server_.get(t).then((i=>{const r=Do(i).withIndex(t._queryParams.getIndex());let s;if(El(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=Il(e.serverSyncTree_,t._path,r);else{const n=Ol(e.serverSyncTree_,t);s=Tl(e.serverSyncTree_,t._path,r,n)}return gc(e.eventQueue_,t._path,s),Nl(e.serverSyncTree_,t,n,null,!0),r}),(n=>(Rc(e,"get for query "+P(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new Kc(t,new Xc(e._repo,e._path),e._queryParams.getIndex())))}class eu{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new jc("value",this,new Kc(e.snapshotNode,new Xc(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Hc(this,e,t):null}matches(e){return e instanceof eu&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}class tu{respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Hc(this,e,t):null}createEvent(e,t){d(null!=e.childName,"Child events should have a childName.");const n=Gc(new Xc(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new jc(e.type,this,new Kc(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof tu&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}constructor(e,t){this.eventType=e,this.callbackContext=t}}function nu(e,t,n,i,r){let s;if("object"==typeof i&&(s=void 0,r=i),"function"==typeof i&&(s=i),r&&r.onlyOnce){const t=n,i=(n,i)=>{Ec(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Vc(n,s||void 0),a="value"===t?new eu(o):new tu(t,o);return function(e,t,n){let i;i=".info"===$s(t._path)?El(e.infoSyncTree_,t,n):El(e.serverSyncTree_,t,n),mc(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>Ec(e._repo,e,a)}function iu(e,t,n,i){return nu(e,"value",t,n,i)}!function(e){d(!ll,"__referenceConstructor has already been defined"),ll=e}(Xc),function(e){d(!cl,"__referenceConstructor has already been defined"),cl=e}(Xc);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const ru={};let su=!1;function ou(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||us("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),as("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=qc(s,r),c=l.repoInfo;void 0!==Ar&&Ar.env&&(a=Ar.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=qc(s,r),c=l.repoInfo):o=!l.repoInfo.secure;const u=r&&o?new Ns(Ns.OWNER):new Is(e.name,e.options,t);dc("Invalid Firebase Database URL",l),Zs(l.path)||us("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,i){let r=ru[t.name];r||(r={},ru[t.name]=r);let s=r[e.toURLString()];s&&us("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new _c(e,su,n,i),r[e.toURLString()]=s,s}(c,e,u,new Cs(e.name,n));return new au(h,e)}class au{get _repo(){return this._instanceStarted||(bc(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Xc(this._repo,Vs())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=ru[t];n&&n[e.key]===e||us(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Sc(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&us("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}ao.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},ao.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Kr="9.10.0",Ae(new Z("database",((e,{instanceIdentifier:t})=>ou(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),We("@firebase/database","0.13.6",e),We("@firebase/database","0.13.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const lu=function(e=ze(),t){return Me(e,"database").getImmediate({identifier:t})}(Fe(Pi));let cu="";function uu(e,t){Jc(Qc(Yc(lu,`user/${e}/watched/`)),t)}function hu(e,t){iu(Yc(lu,`user/${e}/watched/`),(n=>{n.forEach((n=>{if(n.val().id===t){cu=n.key;Jc(Yc(lu,`user/${e}/watched/${cu}`),null)}}))}),{onlyOnce:!0})}function du(e,t){Jc(Qc(Yc(lu,`user/${e}/queue/`)),t)}function pu(e,t){iu(Yc(lu,`user/${e}/queue/`),(n=>{n.forEach((n=>{if(n.val().id===t){cu=n.key;Jc(Yc(lu,`user/${e}/queue/${cu}`),null)}}))}),{onlyOnce:!0})}function fu(e){const t=[];return iu(Yc(lu,`user/${e}/queue/`),(e=>{e.forEach((e=>{t.push(e.val())}))}),{onlyOnce:!0}),t}async function mu(e,t){let n=!1;const i=Yc(lu,`user/${e}/watched/`);return(await Zc(i)).forEach((e=>{e.val().id===t&&(n=!0)})),n}async function gu(e,t){let n=!1;const i=Yc(lu,`user/${e}/queue/`);return(await Zc(i)).forEach((e=>{e.val().id===t&&(n=!0)})),n}const yu=document.querySelector(".sign-in-btn"),vu=document.querySelector(".sign-up-btn"),_u=document.querySelector(".form-box"),bu={openModalBtn:document.querySelector("[data-modal-log-open]"),closeModalBtn:document.querySelector("[data-modal-log-close]"),modal:document.querySelector("[data-log-modal]"),body:document.querySelector("body")};function wu(){bu.modal.classList.remove("is-hidden"),bu.body.classList.add("no-scroll"),bu.modal.addEventListener("click",ku),window.addEventListener("keydown",Cu),yr.addEventListener("input",Lr)}function xu(){bu.modal.classList.add("is-hidden"),bu.body.classList.remove("no-scroll"),bu.modal.removeEventListener("click",ku),window.removeEventListener("keydown",Cu)}function ku(e){e.target===e.currentTarget&&xu()}function Cu(e){"Escape"===e.code&&xu()}vu.addEventListener("click",(function(){_u.classList.add("active")})),yu.addEventListener("click",(function(){_u.classList.remove("active")})),bu.openModalBtn.addEventListener("click",wu),bu.closeModalBtn.addEventListener("click",xu);var Iu;Iu=new URL(s("kyEFX").resolve("q2LMx"),import.meta.url).toString();let Nu=[],Tu=[];const Eu=document.querySelector(".header"),Su=document.querySelector(".search-form"),Ru=document.querySelector(".home-link"),Lu=document.querySelector(".library-link"),Pu=document.querySelector(".library-btn__wrap"),Au=document.querySelector(".watched-btn"),Mu=document.querySelector(".queue-btn"),Ou=document.querySelector(".logo-link"),Du=document.querySelector(".section-pagination"),Fu=document.querySelector(".gallery-films"),zu=document.querySelector("#pagination");function Wu(e){Pu.classList.add("visually-hidden"),Su.classList.remove("visually-hidden"),Ru.classList.add("current"),Lu.classList.remove("current"),Eu.classList.remove("header__my-library-bg"),Eu.classList.add("home-header-bg"),zu.style.display="flex",Fu.classList.add("gallery-films")}function Uu(){return Tu=fu(Tr)}function qu(e){setTimeout((function(){if(0!==e.length)return function(e){const t=e.map((e=>{let{poster_path:t,original_title:i,genres:r,release_date:s,vote_average:o}=e;return n(t,i,r,s,o)}));function n(e,t,n,i,r){const s=new Date(`${i}`).getFullYear(),o=[];n.map((e=>o.push(e.name)));return`\n                <li class="photo-card">\n                <a class="link" href="#">\n                  <img src= "https://image.tmdb.org/t/p/w500${e}" alt="${t} loading="lazy" width: 0px class="card-image">\n                  <div class="info">\n                    <p class="info-item">\n                      <b>${t.toUpperCase()}</b>\n                    </p>\n                    <p class="info-item">\n                    <b class="info-genres">${o.join(", ")} | ${s} <span class="info-genres vote-average">${r.toFixed(1)}</span></b>                      \n                                          </p>                   \n                  </div>\n                  </a>\n                </li>`}Fu.innerHTML="",Fu.insertAdjacentHTML("afterbegin",t.join(""))}(e);Fu.style.justifyContent="center",Fu.innerHTML=`<li>\n  <p class="empty-library__text"> There is nothing here yet! </p>\n  <img class="empty-library__image" src="${t(Iu)}" alt="empty cinema hall">\n  </li>`,document.querySelector(".empty-library__text").style.margin="0",Du.style.display="none"}),150)}Ru.addEventListener("click",Wu),Lu.addEventListener("click",(function(e){e.preventDefault(),Au.classList.remove("active"),Mu.classList.add("active"),Uu(),null!==Tr?(Su.classList.add("visually-hidden"),Pu.classList.remove("visually-hidden"),Lu.classList.add("current"),Ru.classList.remove("current"),Eu.classList.remove("home-header-bg"),Eu.classList.add("header__my-library-bg"),qu(Tu)):wu()})),Au.addEventListener("click",(function(){Mu.classList.remove("active"),Au.classList.add("active"),Au.disabled=!0,Mu.disabled=!1,Nu=function(e){const t=[];return iu(Yc(lu,`user/${e}/watched/`),(e=>{e.forEach((e=>{t.push(e.val())}))}),{onlyOnce:!0}),t}(Tr),qu(Nu)})),Mu.addEventListener("click",(function(){Au.classList.remove("active"),Mu.classList.add("active"),Au.disabled=!1,Mu.disabled=!0,Uu(),qu(Tu)})),Ou.addEventListener("click",Wu);const Bu={KEY:"a115fde3660c9e5b413d785f288ed44e",btnWatchedEl:document.querySelector("#dima-btn-watched"),btnQueueEl:document.querySelector("#dima-btn-queue"),btnWatchedItemAdd:document.querySelector(".d-add-watched"),btnWatchedItemRemove:document.querySelector(".d-remove-watched"),btnQueueItemAdd:document.querySelector(".d-add-queue"),btnQueueItemRemove:document.querySelector(".d-remove-queue")};async function ju(e){const t=await fetch(`\nhttps://api.themoviedb.org/3/movie/${e}?api_key=${Bu.KEY}&language=en-US`);return await t.json()}Bu.btnQueueEl.classList.remove("active"),Bu.btnWatchedEl.addEventListener("click",(()=>async function(e,t){Bu.btnWatchedEl.classList.add("active"),Bu.btnQueueEl.classList.remove("active");const n=await mu(e,t);ju(t).then((i=>{if(n)return hu(e,t),void console.log("вызвали удалить");uu(e,i),console.log("вызвали добавить"),console.log(i)})),Bu.btnWatchedItemAdd.classList.toggle("hide"),Bu.btnWatchedItemRemove.classList.toggle("hide")}(642885))),Bu.btnQueueEl.addEventListener("click",(()=>async function(e){Bu.btnWatchedEl.classList.remove("active"),Bu.btnQueueEl.classList.add("active");const t=await gu(currentUserId,e);ju(e).then((n=>{if(t)return pu(currentUserId,e),void console.log("вызвали удалить");du(currentUserId,n),console.log("вызвали добавить"),console.log(n)})),Bu.btnQueueItemAdd.classList.toggle("hide"),Bu.btnQueueItemRemove.classList.toggle("hide")}(762504)));var Hu={};Hu=function e(t,n,i){function r(o,a){if(!n[o]){if(!t[o]){var l=void 0;if(!a&&l)return l(o,!0);if(s)return s(o,!0);var c=new Error("Cannot find module '"+o+"'");throw c.code="MODULE_NOT_FOUND",c}var u=n[o]={exports:{}};t[o][0].call(u.exports,(function(e){return r(t[o][1][e]||e)}),u,u.exports,e,t,n,i)}return n[o].exports}for(var s=void 0,o=0;o<i.length;o++)r(i[o]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var i=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},s=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=s,n.create=function(e,t){var n=function(e,t){var n=i('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),s=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return s.appendChild(e)}));var o=r(s,"IMG"),a=r(s,"VIDEO"),l=r(s,"IFRAME");return!0===o&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===l&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(i(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),o=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===s(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&o()}));var a={element:function(){return n},visible:function(){return s(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:o};return a}},{}]},{},[1])(1);var Vu;Vu=new URL(s("kyEFX").resolve("gOLlt"),import.meta.url).toString();var $u;$u=new URL(s("kyEFX").resolve("iTfR5"),import.meta.url).toString();var Xu;Xu=new URL(s("kyEFX").resolve("7nYPu"),import.meta.url).toString();var Ku;Ku=new URL(s("kyEFX").resolve("fkcxk"),import.meta.url).toString();var Yu;Yu=new URL(s("kyEFX").resolve("acMhR"),import.meta.url).toString();var Gu;Gu=new URL(s("kyEFX").resolve("cshoN"),import.meta.url).toString();var Qu;Qu=new URL(s("kyEFX").resolve("jOnoa"),import.meta.url).toString();var Ju;Ju=new URL(s("kyEFX").resolve("eQ6pA"),import.meta.url).toString();var Zu;Zu=new URL(s("kyEFX").resolve("em9Db"),import.meta.url).toString();var eh;eh=new URL(s("kyEFX").resolve("6n6Lh"),import.meta.url).toString();var th;th=new URL(s("kyEFX").resolve("eqJcO"),import.meta.url).toString();var nh;nh=new URL(s("kyEFX").resolve("56Ciu"),import.meta.url).toString();const ih=`<div class="modal-team" id="modalTeam"><div class="team-card">\n    <img src="${t(Vu)}" alt="Yegor" class="team-image">\n    <p class="team-name">Yegor</p>\n    <p class="team-role">'Developer, TeamLead'</p>\n    <a href="https://github.com/YehorRyltsov" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#github"></use>\n    </svg></a>\n    <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t($u)}" alt="Valerii" class="team-image">\n    <p class="team-name">Valerii</p>\n    <p class="team-role">'Developer, Scram master'</p>\n    <a href="https://github.com/Valerii-Postrybailo" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Xu)}" alt="Khrystyna" class="team-image">\n    <p class="team-name">Khrystyna</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/kmykolaichuk" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Ku)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/NataliiaKulchytska" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Yu)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Nataliphoenix" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Gu)}" alt="Sergei" class="team-image">\n    <p class="team-name">Sergei</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/seroga213" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Qu)}" alt="Vitalii" class="team-image">\n    <p class="team-name">Vitalii</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/VitaliiMazur" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/vitalii-mazur-5612b9237" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Ju)}" alt=">Yuriy" class="team-image">\n    <p class="team-name">Yuriy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Shavursky" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(eh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">DmytroK</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Scumsy" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Zu)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/bigmandarine" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(th)}" alt="Arseniy" class="team-image">\n    <p class="team-name">Arseny</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/arseniy-grinev" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(nh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(nh)}#in"></use>\n    </svg></a>\n</div>\n</div>\n`;document.querySelector("[data-modal-open-team]").addEventListener("click",(function(e){e.preventDefault(),rh.show(),window.addEventListener("keydown",sh),sh()}));const rh=Hu.create(ih);function sh(e){"Escape"===e.code&&(rh.close(),window.removeEventListener("keydown",sh))}const oh=document.querySelector(".scroll-top");oh.addEventListener("click",(function(e){window.scrollTo({top:0,behavior:"smooth"}),Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600)})),window.addEventListener("scroll",(function(e){window.pageYOffset<100?oh.classList.add("is-hidden"):oh.classList.remove("is-hidden")})),t(l).Notify.init({position:"center-top"});
//# sourceMappingURL=index.6cbaaf61.js.map
