 ...
 * limitations under the License.
 */
function(e=ze()){const t=Me(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Me(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(q(n.getOptions(),null!=t?t:{}))return e;tt(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Si,persistence:[Vn,Ln,An]})}(Fe(Pi));function ru(e,n){Tn(iu,e,n).then((n=>{t(l).Notify.success(`Yahoooo!!!! Welcome ${e}`);n.user})).catch((e=>{e.code,e.message;console.error(e.message),t(l).Notify.failure("We cant create user likes this")}))}function su(e,n){En(iu,e,n).then((e=>{t(l).Notify.success("Login success");e.user})).catch((e=>{t(l).Notify.failure("Login failure")}))}function ou(){J(iu).signOut(),t(l).Notify.info("You just logOut"),tu(1)}const au=document.querySelector(".header"),lu=document.querySelector(".search-form"),cu=document.querySelector(".home-link"),uu=document.querySelector(".library-link"),hu=document.querySelector(".library-btn__wrap"),du=document.querySelector(".gallery-films");const pu=document.querySelector("#email-input"),fu=document.querySelector("#pwd-input"),mu=document.querySelector("#second-pwd-input"),gu=document.querySelector("#register-form"),yu=document.querySelector('button[data-id="log-out"]'),vu=document.querySelector("#login-email-input"),_u=document.querySelector("#login-pwd-input"),bu=document.querySelector("#login-form"),wu=(document.querySelector("#form-login-btn"),document.querySelector("#form-signup-btn")),xu=document.querySelector(".form-register-svg.pwdInput"),ku=document.querySelector(".form-register-svg.pwdRepeatInput"),Cu=document.querySelector('button[data-id="log-in"]'),Iu=document.querySelector("[data-log-modal]"),Nu=document.querySelector("body");let Tu=null;var Eu,Su,Ru;function Lu(e){const t=e.currentTarget,n=fu.value;t.value===n?(fu.classList.add("checked"),mu.classList.add("checked"),xu.classList.add("checked"),ku.classList.add("checked"),wu.disabled=!1):(Pu(),wu.disabled=!0)}function Pu(){fu.classList.remove("checked"),mu.classList.remove("checked"),xu.classList.remove("checked"),ku.classList.remove("checked")}yu.addEventListener("click",(function(){ou(),hu.classList.add("visually-hidden"),lu.classList.remove("visually-hidden"),cu.classList.add("current"),uu.classList.remove("current"),au.classList.remove("header__my-library-bg"),au.classList.add("home-header-bg"),du.classList.add("gallery-films"),tu(1)})),gu.addEventListener("submit",(function(e){e.preventDefault(),Pu();try{ru(pu.value,fu.value),e.currentTarget.reset()}catch(t){e.currentTarget.reset()}})),bu.addEventListener("submit",(function(e){e.preventDefault();try{su(vu.value,_u.value),e.currentTarget.reset()}catch(e){}})),Eu=e=>{e?(Cu.classList.add("visually-hidden"),yu.classList.remove("visually-hidden"),Iu.classList.add("is-hidden"),Nu.classList.remove("no-scroll"),Tu=e.uid,console.log(`юзер залогинен, ID = ${e.uid}`)):(Tu=null,Cu.classList.remove("visually-hidden"),yu.classList.add("visually-hidden"))},J(iu).onAuthStateChanged(Eu,Su,Ru);var Au;Au=new URL(s("kyEFX").resolve("q2LMx"),import.meta.url).toString();let Mu=[],Ou=[];const Du=document.querySelector(".header"),Fu=document.querySelector(".search-form"),zu=document.querySelector(".home-link"),Wu=document.querySelector(".library-link"),qu=document.querySelector(".library-btn__wrap"),Uu=document.querySelector(".watched-btn"),Bu=document.querySelector(".queue-btn"),ju=document.querySelector(".logo-link"),Hu=document.querySelector(".section-pagination"),Vu=document.querySelector(".gallery-films"),$u=document.querySelector("#pagination");function Xu(e){qu.classList.add("visually-hidden"),Fu.classList.remove("visually-hidden"),zu.classList.add("current"),Wu.classList.remove("current"),Du.classList.remove("header__my-library-bg"),Du.classList.add("home-header-bg"),$u.style.display="flex",Vu.classList.add("gallery-films")}function Ku(){return Ou=yc(Tu)}function Yu(e){Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600),setTimeout((function(){if(0!==e.length)return function(e){const t=e.map((e=>{let{poster_path:t,original_title:i,genres:r,release_date:s,vote_average:o,id:a}=e;return n(t,i,r,s,o,a)}));function n(e,t,n,i,r,s){const o=new Date(`${i}`).getFullYear(),a=[];n.map((e=>a.push(e.name)));return`\n                <li class="photo-card" data-idcard="${s}">\n                <a class="link" href="#">\n                  <img src= "https://image.tmdb.org/t/p/w500${e}" alt="${t} loading="lazy" width: 0px class="card-image">\n                  <div class="info">\n                    <p class="info-item">\n                      <b>${t.toUpperCase()}</b>\n                    </p>\n                    <p class="info-item">\n                    <b class="info-genres">${a.join(", ")} | ${o} <span class="info-genres vote-average">${r.toFixed(1)}</span></b>                      \n                                          </p>                   \n                  </div>\n                  </a>\n                </li>`}Vu.innerHTML="",Vu.insertAdjacentHTML("afterbegin",t.join(""))}(e);Vu.style.justifyContent="center",Vu.innerHTML=`<li>\n  <p class="empty-library__text"> There is nothing here yet! </p>\n  <img class="empty-library__image" src="${t(Au)}" alt="empty cinema hall">\n  </li>`,document.querySelector(".empty-library__text").style.margin="0",Hu.style.display="none"}),300)}zu.addEventListener("click",Xu),Wu.addEventListener("click",(function(e){e.preventDefault(),Uu.classList.remove("active"),Bu.classList.add("active"),Ku(),null!==Tu?(Fu.classList.add("visually-hidden"),qu.classList.remove("visually-hidden"),Wu.classList.add("current"),zu.classList.remove("current"),Du.classList.remove("home-header-bg"),Du.classList.add("header__my-library-bg"),Yu(Ou)):Cc()})),Uu.addEventListener("click",(function(){Bu.classList.remove("active"),Uu.classList.add("active"),Uu.disabled=!0,Bu.disabled=!1,Mu=function(e){const t=[];return oc(Jl(hc,`user/${e}/watched/`),(e=>{e.forEach((e=>{t.push(e.val())}))}),{onlyOnce:!0}),t}(Tu),Yu(Mu)})),Bu.addEventListener("click",(function(){Uu.classList.remove("active"),Bu.classList.add("active"),Uu.disabled=!1,Bu.disabled=!0,Ku(),Yu(Ou)})),ju.addEventListener("click",Xu);var Gu={};Gu=function e(t,n,i){function r(o,a){if(!n[o]){if(!t[o]){var l=void 0;if(!a&&l)return l(o,!0);if(s)return s(o,!0);var c=new Error("Cannot find module '"+o+"'");throw c.code="MODULE_NOT_FOUND",c}var u=n[o]={exports:{}};t[o][0].call(u.exports,(function(e){return r(t[o][1][e]||e)}),u,u.exports,e,t,n,i)}return n[o].exports}for(var s=void 0,o=0;o<i.length;o++)r(i[o]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var i=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},s=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=s,n.create=function(e,t){var n=function(e,t){var n=i('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),s=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return s.appendChild(e)}));var o=r(s,"IMG"),a=r(s,"VIDEO"),l=r(s,"IFRAME");return!0===o&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===l&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(i(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),o=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===s(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&o()}));var a={element:function(){return n},visible:function(){return s(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:o};return a}},{}]},{},[1])(1);var Qu;Qu=new URL(s("kyEFX").resolve("gOLlt"),import.meta.url).toString();var Ju;Ju=new URL(s("kyEFX").resolve("iTfR5"),import.meta.url).toString();var Zu;Zu=new URL(s("kyEFX").resolve("7nYPu"),import.meta.url).toString();var eh;eh=new URL(s("kyEFX").resolve("fkcxk"),import.meta.url).toString();var th;th=new URL(s("kyEFX").resolve("acMhR"),import.meta.url).toString();var nh;nh=new URL(s("kyEFX").resolve("cshoN"),import.meta.url).toString();var ih;ih=new URL(s("kyEFX").resolve("jOnoa"),import.meta.url).toString();var rh;rh=new URL(s("kyEFX").resolve("eQ6pA"),import.meta.url).toString();var sh;sh=new URL(s("kyEFX").resolve("em9Db"),import.meta.url).toString();var oh;oh=new URL(s("kyEFX").resolve("6n6Lh"),import.meta.url).toString();var ah;ah=new URL(s("kyEFX").resolve("eqJcO"),import.meta.url).toString();var lh;lh=new URL(s("kyEFX").resolve("56Ciu"),import.meta.url).toString();const ch=`<div class="modal-team" id="modalTeam"><div class="team-card">\n    <img src="${t(Qu)}" alt="Yegor" class="team-image">\n    <p class="team-name">Yegor</p>\n    <p class="team-role">'Developer, TeamLead'</p>\n    <a href="https://github.com/YehorRyltsov" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#github"></use>\n    </svg></a>\n    <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Ju)}" alt="Valerii" class="team-image">\n    <p class="team-name">Valerii</p>\n    <p class="team-role">'Developer, Scram master'</p>\n    <a href="https://github.com/Valerii-Postrybailo" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(Zu)}" alt="Khrystyna" class="team-image">\n    <p class="team-name">Khrystyna</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/kmykolaichuk" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/khrystyna-mykolaichuk-29275b163" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(eh)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/NataliiaKulchytska" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(th)}" alt="Nataliia" class="team-image">\n    <p class="team-name">Nataliia</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Nataliphoenix" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(nh)}" alt="Sergei" class="team-image">\n    <p class="team-name">Sergei</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/seroga213" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ih)}" alt="Vitalii" class="team-image">\n    <p class="team-name">Vitaliy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/VitaliiMazur" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/in/vitalii-mazur-5612b9237" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(rh)}" alt=">Yuriy" class="team-image">\n    <p class="team-name">Yura</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Shavursky" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(oh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/Scumsy" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(sh)}" alt="Dmytro" class="team-image">\n    <p class="team-name">Dmytro</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/bigmandarine" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n<div class="team-card">\n    <img src="${t(ah)}" alt="Arseniy" class="team-image">\n    <p class="team-name">Arseniy</p>\n    <p class="team-role">'Developer'</p>\n    <a href="https://github.com/arseniy-grinev" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n      <use href="${t(lh)}#github"></use>\n    </svg></a>\n      <a href="https://linkedin.com/" target="_blank" class="team-git team-in"><svg class="logo__icon" width="24" height="24">\n      <use  href="${t(lh)}#in"></use>\n    </svg></a>\n</div>\n</div>\n`,uh=document.querySelector("[data-modal-open-team]"),hh=document.querySelector("body");document.querySelector("#modalTeam");uh.addEventListener("click",(function(e){e.preventDefault(),dh.show(),window.addEventListener("keydown",ph),hh.classList.add("noScroll"),ph(e)}));const dh=Gu.create(ch,{onClose:e=>{hh.classList.remove("noScroll")}});function ph(e){"Escape"===e.code&&(dh.close(),window.removeEventListener("keydown",ph))}const fh=document.querySelector(".scroll-top");fh.addEventListener("click",(function(e){window.scrollTo({top:0,behavior:"smooth"}),Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(600)})),window.addEventListener("scroll",(function(e){window.pageYOffset<100?fh.classList.add("is-hidden"):fh.classList.remove("is-hidden")}));Oi.Loading.pulse({svgSize:"150px",svgColor:"#FF6B08"}),Oi.Loading.remove(400),t(l).Notify.init({position:"center-top"});
//# sourceMappingURL=index.4cb1f936.js.map
